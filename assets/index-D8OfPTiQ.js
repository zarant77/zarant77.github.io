(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=t(s);fetch(s.href,r)}})();class $d{constructor(e,t,n){this.world=e,this.cfg=t,this.systems=n}step(e){this.world.t+=e;for(const t of this.systems)t(this.world,this.cfg,e)}setConfig(e){this.cfg=e}}class vu{constructor(e,t,n=()=>!1){this.fixedDt=e,this.step=t,this.isPaused=n}acc=0;lastMs=0;tick(e){if(this.lastMs===0&&(this.lastMs=e),this.isPaused()){this.lastMs=e,this.acc=0;return}const t=Math.max(0,(e-this.lastMs)/1e3);for(this.lastMs=e,this.acc+=t;this.acc>=this.fixedDt;)this.step(this.fixedDt),this.acc-=this.fixedDt}}const Zd={"app.title":"Kestrel Drift","app.logo_alt":"Kestrel Drift logo","ui.menu":"Menu","ui.loading":"Loading","ui.fullscreen":"Fullscreen","menu.continue":"Continue","menu.restart":"Restart","menu.keybindings":"Keybindings","menu.gamepad":"Gamepad calibration","menu.settings":"Settings","common.back":"← Back","common.apply":"Apply","common.save":"Save","common.reset":"Reset","common.canceled":"Canceled.","hint.esc_close":"Esc — close","hint.esc_back":"Esc — back","hint.esc_cancel_back":"Esc — cancel capture / back","kb.reset_defaults":"Reset to defaults","kb.hint_click_bind":"Click a bind to rebind.","kb.gamepad_note":"Gamepad (alt): Toggle Cam = Button 1, Toggle Dev = Button 9, Drop = Button 0, Cam Tilt = Axis 4, Cam Zoom = Axis 5","kb.press_key_for":"Press a key for: {id} (Esc to cancel)","kb.bound":"Bound {id} to {key}.","kb.reset_done":"Reset done.","kb.bind.throttleUp":"Throttle Up","kb.bind.throttleDown":"Throttle Down","kb.bind.yawLeft":"Yaw Left","kb.bind.yawRight":"Yaw Right","kb.bind.pitchUp":"Pitch Up","kb.bind.pitchDown":"Pitch Down","kb.bind.rollLeft":"Roll Left","kb.bind.rollRight":"Roll Right","kb.bind.camTiltUp":"Camera Tilt Up","kb.bind.camTiltDown":"Camera Tilt Down","kb.bind.camZoomIn":"Camera Zoom In","kb.bind.camZoomOut":"Camera Zoom Out","kb.bind.minimapZoomIn":"Minimap Zoom In","kb.bind.minimapZoomOut":"Minimap Zoom Out","kb.bind.drop":"Drop Payload","kb.bind.toggleDev":"Toggle Debug","kb.bind.toggleCam":"Switch Camera View","kb.bind.restart":"Restart Simulation","settings.language":"Language","settings.drone_preset":"Drone preset","settings.select_zone":"Select zone","settings.wind_enabled":"Wind enabled","settings.wind_direction":"Wind direction","settings.wind_dir_viz":"Wind direction visualization","settings.wind_base_speed":"Base speed (m/s)","settings.wind_gust_max":"Gust max (m/s)","settings.variation":"Variation","settings.gustiness":"Gustiness","gp.waiting":"Waiting for gamepad… (press any button/stick to wake it)","gp.no_gamepad":"No gamepad detected. Press any button/stick to wake it.","gp.detected":"{id} (axes {axes}, buttons {buttons})","gp.hint_click_field":"Click a field to rebind. Esc to cancel.","gp.axis_captured":"Axis captured.","gp.button_captured":"Button captured.","gp.axis_captured_for_action":"Axis captured for action.","gp.axis_line":"AXIS {i}  {v}","gp.btn_none":"BTN: none","gp.btn_list":"BTN: {list}","gp.move_axis_for":"Move axis for: {key} (Esc to cancel)","gp.press_button_for":"Press button for: {key} (Esc to cancel)","gp.move_axis_for_action":"Move axis for action: {key} (Esc to cancel)","gp.swap_yaw_roll":"Swap Yaw/Roll","gp.inverted":"Inverted","gp.normal":"Normal","gp.bind_axis":"Bind Axis","gp.buttons_header":"Buttons","gp.invert_toggled":"Invert toggled.","gp.saved":"Saved to localStorage.","gp.reset_defaults":"Reset to defaults.","gp.bind.yaw":"Yaw","gp.bind.pitch":"Pitch","gp.bind.roll":"Roll","gp.bind.throttle":"Throttle","gp.bind.cam_tilt":"Cam Tilt","gp.bind.cam_zoom":"Cam Zoom","gp.bind.drop":"Drop","gp.bind.toggle_cam":"Toggle Cam","gp.bind.restart":"Restart","gp.bind.toggle_dev":"Toggle Dev","osd.mission.title":"MISSION","osd.mission.status.empty":"EMPTY","osd.mission.status.landed":"LANDED","osd.mission.status.dropped":"DROPPED","osd.mission.status.armed":"ARMED","osd.mission.hitTail":"{d}m","osd.mission.hitTailMissing":"--","touch.restart":"RESTART","touch.drop":"DROP","touch.camera":"CAM"},jd={"app.title":"Kestrel Drift","app.logo_alt":"Логотип Kestrel Drift","ui.menu":"Меню","ui.loading":"Завантаження","ui.fullscreen":"Повний екран","menu.continue":"Продовжити","menu.restart":"Перезапустити","menu.keybindings":"Клавіші","menu.gamepad":"Калібрування геймпада","menu.settings":"Налаштування","common.back":"← Назад","common.apply":"Застосувати","common.save":"Зберегти","common.reset":"Скинути","common.canceled":"Скасовано.","hint.esc_close":"Esc — закрити","hint.esc_back":"Esc — назад","hint.esc_cancel_back":"Esc — скасувати захоплення / назад","kb.reset_defaults":"Скинути до стандартних","kb.hint_click_bind":"Натисни на бінд, щоб перев’язати.","kb.gamepad_note":"Геймпад (alt): Toggle Cam = Button 1, Toggle Dev = Button 9, Drop = Button 0, Cam Tilt = Axis 4, Cam Zoom = Axis 5","kb.press_key_for":"Натисни клавішу для: {id} (Esc — скасувати)","kb.bound":"Прив’язано {id} до {key}.","kb.reset_done":"Скинуто.","kb.bind.throttleUp":"Газ вгору","kb.bind.throttleDown":"Газ вниз","kb.bind.yawLeft":"Yaw вліво","kb.bind.yawRight":"Yaw вправо","kb.bind.pitchUp":"Pitch вгору","kb.bind.pitchDown":"Pitch вниз","kb.bind.rollLeft":"Roll вліво","kb.bind.rollRight":"Roll вправо","kb.bind.camTiltUp":"Тілт камери вгору","kb.bind.camTiltDown":"Тілт камери вниз","kb.bind.camZoomIn":"Зум камери +","kb.bind.camZoomOut":"Зум камери −","kb.bind.minimapZoomIn":"Зум мапи +","kb.bind.minimapZoomOut":"Зум мапи -","kb.bind.drop":"Скинути вантаж","kb.bind.toggleDev":"Debug режим","kb.bind.toggleCam":"Перемкнути камеру","kb.bind.restart":"Перезапуск симуляції","settings.language":"Мова","settings.drone_preset":"Пресет дрона","settings.select_zone":"Вибір зони","settings.wind_enabled":"Вітер увімкнено","settings.wind_direction":"Напрям вітру","settings.wind_dir_viz":"Візуалізація напрямку вітру","settings.wind_base_speed":"Базова швидкість (м/с)","settings.wind_gust_max":"Макс. порив (м/с)","settings.variation":"Варіативність","settings.gustiness":"Пористість","gp.waiting":"Очікую геймпад… (натисни будь-яку кнопку/стік, щоб розбудити)","gp.no_gamepad":"Геймпад не знайдено. Натисни будь-яку кнопку/стік, щоб розбудити.","gp.detected":"{id} (осі {axes}, кнопки {buttons})","gp.hint_click_field":"Клікни по полю, щоб перев’язати. Esc — скасувати.","gp.axis_captured":"Вісь захоплено.","gp.button_captured":"Кнопку захоплено.","gp.axis_captured_for_action":"Вісь захоплено для дії.","gp.axis_line":"AXIS {i}  {v}","gp.btn_none":"BTN: немає","gp.btn_list":"BTN: {list}","gp.move_axis_for":"Рухни вісь для: {key} (Esc — скасувати)","gp.press_button_for":"Натисни кнопку для: {key} (Esc — скасувати)","gp.move_axis_for_action":"Рухни вісь для дії: {key} (Esc — скасувати)","gp.swap_yaw_roll":"Поміняти Yaw/Roll місцями","gp.inverted":"Інвертовано","gp.normal":"Нормально","gp.bind_axis":"Прив’язати вісь","gp.buttons_header":"Кнопки","gp.invert_toggled":"Інверсію перемкнуто.","gp.saved":"Збережено в localStorage.","gp.reset_defaults":"Скинуто до стандартних.","gp.bind.yaw":"Yaw","gp.bind.pitch":"Pitch","gp.bind.roll":"Roll","gp.bind.throttle":"Throttle","gp.bind.cam_tilt":"Tilt камери","gp.bind.cam_zoom":"Зум камери","gp.bind.drop":"Скидання","gp.bind.toggle_cam":"Камера","gp.bind.restart":"Рестарт","gp.bind.toggle_dev":"Dev","osd.mission.title":"МІСІЯ","osd.mission.status.empty":"ПУСТО","osd.mission.status.landed":"НА ЗЕМЛІ","osd.mission.status.dropped":"СКИНУТО","osd.mission.status.armed":"ГОТОВИЙ","osd.mission.hitTail":"{d}м","osd.mission.hitTailMissing":"--","touch.restart":"РЕСТАРТ","touch.drop":"СКИД","touch.camera":"КАМЕРА"},Dc={uk:"Українська",en:"English"},Ml={en:Zd,uk:jd},Mu="kd.locale";let Ic=Qd();function jr(){return Ic}function Jd(i){Ic=i,localStorage.setItem(Mu,i)}function Qd(){const i=localStorage.getItem(Mu);return i&&i in Dc?i:"uk"}function ke(i,e){const t=Ml[Ic][i]??Ml.en[i]??i;return e?t.replace(/\{(\w+)\}/g,(n,s)=>String(e[s]??`{${s}}`)):t}const yu="kd.gp.lastId",Lc="kd.gp.calib.v1.";function Su(i,e,t){return Math.max(e,Math.min(t,i))}function ef(){const i=localStorage.getItem(yu);if(!i)return null;const e=Nc(i);return e?{id:i,calib:e}:null}function tf(i){return(i.id||"gamepad").toLowerCase().trim().replace(/\s+/g," ").slice(0,120)}function aa(){return{axis:{roll:0,pitch:1,thr:2,yaw:3,camTilt:4,camZoom:5},invert:{roll:1,pitch:1,yaw:1,thr:1,camTilt:-1,camZoom:1},buttons:{drop:0,restart:1,toggleCam:-6,toggleDev:-7},swapYawRoll:!1}}function nf(i,e){const t=i||"gamepad",n=Lc+t;localStorage.setItem(n,JSON.stringify(e)),localStorage.setItem(yu,t)}function Nc(i){const e=Lc+(i||"gamepad"),t=localStorage.getItem(e);if(!t)return null;try{const n=JSON.parse(t);return!n?.axis||!n?.invert||!n?.buttons?null:n}catch{return null}}function sf(i){const e=i||"gamepad",t=Lc+e;return localStorage.removeItem(t),localStorage.getItem("kd.gp.lastId")===e&&localStorage.removeItem("kd.gp.lastId"),aa()}function Tn(i,e){return Su(i.axes?.[e]??0,-1,1)}function Ri(i,e){return i.buttons?.[e]?.pressed??!1}function yl(i,e){return Su(i.buttons?.[e]?.value??0,0,1)}let oa=[],ca=[],Po=[],Do=[];function Bn(i){const e=i.axes?.length??0;oa=new Array(e),Po=new Array(e);for(let n=0;n<e;n++){const s=Tn(i,n);oa[n]=s,Po[n]=s}const t=i.buttons?.length??0;ca=new Array(t),Do=new Array(t);for(let n=0;n<t;n++){const s=Ri(i,n);ca[n]=s,Do[n]=s}}function Sl(i,e=.6){const s=i.axes?.length??0;for(let r=0;r<s;r++){const a=Tn(i,r),o=oa[r]??a,c=Po[r]??0;oa[r]=a;const l=Math.abs(a)>=e,h=Math.abs(a-c)>=.25,u=Math.abs(a-o)>.06;if(l&&h&&u)return r}return null}function rf(i){const e=i.buttons?.length??0;for(let t=0;t<e;t++){const n=Ri(i,t),s=ca[t]??!1;ca[t]=n;const r=Do[t]??!1;if(n&&!s&&!r)return t}return null}const bl={name:"Generic Mode 2",match:i=>!0,axis:{roll:3,pitch:1,thr:2,yaw:0},invert:{roll:1,pitch:1,yaw:1,thr:1}},af={name:"Radiomaster TX12 Mode 2",match:i=>{const e=i.toLowerCase();return e.includes("radiomaster")||e.includes("tx12")||e.includes("opentx")||e.includes("edgetx")},axis:{roll:0,pitch:1,thr:2,yaw:3},invert:{roll:1,pitch:1,yaw:1,thr:1}};function of(i){return[af,bl].find(t=>t.match(i))??bl}const El=[],Tl=[];function Na(i,e,t=.6){if(e>=0){const o=Ri(i,e),c=El[e]??!1;return El[e]=o,o&&!c}const n=Math.abs(e),s=Tn(i,n),r=Math.abs(s)>=t,a=Tl[n]??!1;return Tl[n]=r,r&&!a}function cf(i){const e=Nc(i);if(e)return e;const t=of(i),n=aa();return n.axis.roll=t.axis.roll,n.axis.pitch=t.axis.pitch,n.axis.yaw=t.axis.yaw,n.axis.thr=t.axis.thr,n.invert.roll=t.invert.roll,n.invert.pitch=t.invert.pitch,n.invert.yaw=t.invert.yaw,n.invert.thr=t.invert.thr,n}function lf(){const i=navigator.getGamepads?.()??[],e=Array.from(i).find(Boolean)??null;if(!e)return{connected:!1,gamepadId:"no gamepad",gamepadIndex:-1,rcRaw:{roll:0,pitch:0,yaw:0,thr:0},frame:{roll:0,pitch:0,yaw:0,throttle:0,drop:!1},extras:{cam:{tiltAxis:0,zoomAxis:0},actions:{toggleCam:!1,toggleDev:!1,restart:!1}}};const t=e.id||"gamepad",n=cf(t),s=n.invert.roll*Tn(e,n.axis.roll),r=n.invert.pitch*Tn(e,n.axis.pitch),a=n.invert.yaw*Tn(e,n.axis.yaw),o=n.invert.thr*Tn(e,n.axis.thr),c=n.swapYawRoll?a:s,l=n.swapYawRoll?s:a,h=r,u=o,d=Na(e,n.buttons.toggleCam),m=Na(e,n.buttons.toggleDev),g=Na(e,n.buttons.restart),_=Ri(e,n.buttons.drop),p=.08,f=n.invert.camTilt*Tn(e,n.axis.camTilt),y=Math.abs(f)<p?0:f,b=n.invert.camZoom*Tn(e,n.axis.camZoom),S=Math.abs(b)<p?0:b,T=yl(e,6),w=yl(e,7),R=Ri(e,14),x=(Ri(e,15)?1:0)-(R?1:0),M=w-T,P=Math.abs(M)>.001?M:x,N=S!==0?S:P;return{connected:!0,gamepadId:t,gamepadIndex:e.index??-1,rcRaw:{roll:c,pitch:h,yaw:l,thr:u},frame:{roll:c,pitch:h,yaw:l,throttle:u,drop:_},extras:{cam:{tiltAxis:y,zoomAxis:N},actions:{toggleCam:d,toggleDev:m,restart:g}}}}const bu="kd.keybinds.v1",Jr={throttleUp:"KeyW",throttleDown:"KeyS",yawLeft:"KeyA",yawRight:"KeyD",rollLeft:"ArrowLeft",rollRight:"ArrowRight",pitchUp:"ArrowUp",pitchDown:"ArrowDown",camZoomOut:"KeyQ",camZoomIn:"KeyE",camTiltUp:"KeyR",camTiltDown:"KeyF",drop:"Space",toggleDev:"KeyZ",toggleCam:"KeyC",restart:"KeyX",minimapZoomOut:"BracketLeft",minimapZoomIn:"BracketRight"};function la(){try{const i=localStorage.getItem(bu);if(!i)return{...Jr};const e=JSON.parse(i);return{...Jr,...e}}catch{return{...Jr}}}function Eu(i){localStorage.setItem(bu,JSON.stringify(i))}function hf(){const i={...Jr};return Eu(i),i}function wl(i){return i==="Space"?"Space":i.startsWith("Key")?i.slice(3):i.startsWith("Digit")?i.slice(5):i.startsWith("Arrow")?i.replace("Arrow","Arrow "):i}const wt=new Set,Mi=new Set,Tu=new Set(["ArrowUp","ArrowDown","ArrowLeft","ArrowRight","Space"]);window.addEventListener("keydown",i=>{Tu.has(i.code)&&i.preventDefault(),wt.has(i.code)||Mi.add(i.code),wt.add(i.code)});window.addEventListener("keyup",i=>{Tu.has(i.code)&&i.preventDefault(),wt.delete(i.code)});function Ti(i,e){return(e?1:0)-(i?1:0)}function uf(){const i=la(),e=wt.has(i.throttleUp),t=wt.has(i.throttleDown),n=wt.has(i.yawLeft),s=wt.has(i.yawRight),r=wt.has(i.rollLeft),a=wt.has(i.rollRight),o=wt.has(i.pitchUp),c=wt.has(i.pitchDown);return{roll:Ti(r,a),pitch:Ti(c,o),yaw:Ti(n,s),throttle:Ti(t,e),drop:wt.has(i.drop)}}function df(){const i=la(),e=wt.has(i.camTiltUp),t=wt.has(i.camTiltDown),n=wt.has(i.camZoomOut),s=wt.has(i.camZoomIn),r=wt.has(i.minimapZoomOut),a=wt.has(i.minimapZoomIn),o=Mi.has(i.toggleCam),c=Mi.has(i.toggleDev),l=Mi.has(i.restart);return o&&Mi.delete(i.toggleCam),c&&Mi.delete(i.toggleDev),l&&Mi.delete(i.restart),{cam:{tiltAxis:Ti(e,t),zoomAxis:Ti(n,s)},minimap:{zoomAxis:Ti(r,a)},actions:{toggleCam:o,toggleDev:c,restart:l}}}const Al=64,Rl=.08,Cl=1.4,ff=.006,pf=.25;function mf(i,e,t){return Math.max(e,Math.min(t,i))}function qs(i){return mf(i,-1,1)}function Pl(i,e){return Math.hypot(i.x-e.x,i.y-e.y)}function Dl(i,e){const t=i.x/e,n=i.y/e,s=Math.hypot(t,n);return s<=1?{x:t,y:n}:{x:t/s,y:n/s}}function Il(i,e,t){const n=e,s=Math.abs(i.x)<n?0:(Math.abs(i.x)-n)/(1-n)*Math.sign(i.x),r=Math.abs(i.y)<n?0:(Math.abs(i.y)-n)/(1-n)*Math.sign(i.y),a=Math.sign(s)*Math.pow(Math.abs(s),t),o=Math.sign(r)*Math.pow(Math.abs(r),t);return{x:qs(a),y:qs(o)}}class gf{el=null;pointers=new Map;left={activeId:null,origin:{x:0,y:0},pos:{x:0,y:0}};right={activeId:null,origin:{x:0,y:0},pos:{x:0,y:0}};leftStart={x:0,y:0};rightStart={x:0,y:0};pinchIds=null;pinchDist0=0;dropDown=!1;dropPressedFrame=!1;restartDown=!1;restartPressedFrame=!1;camDown=!1;toggleCamPressedFrame=!1;tiltActiveId=null;tiltLastY=0;tiltDeltaDegFrame=0;zoomDeltaFrame=0;attach(e){this.el||(this.el=e,e.style.touchAction="none",e.style.userSelect="none",e.addEventListener("pointerdown",this.onDown,{passive:!1}),e.addEventListener("pointermove",this.onMove,{passive:!1}),e.addEventListener("pointerup",this.onUp,{passive:!1}),e.addEventListener("pointercancel",this.onUp,{passive:!1}),e.addEventListener("contextmenu",t=>t.preventDefault()))}beginFrame(){this.dropPressedFrame=!1,this.tiltDeltaDegFrame=0,this.zoomDeltaFrame=0}getHudState(){if(this.el){const e=this.el.getBoundingClientRect(),t=e.width,n=e.height,s=72,r=n*.5,a={x:s,y:r},o={x:t-s,y:r};this.left.activeId===null&&(this.left.origin=a),this.right.activeId===null&&(this.right.origin=o)}return{left:this.left,right:this.right,dropDown:this.dropDown,restartDown:this.restartDown,camDown:this.camDown}}snapshot(){const e=(navigator.maxTouchPoints??0)>0,t=Il(this.left.pos,Rl,Cl),n=Il(this.right.pos,Rl,Cl),s=t.x,r=-t.y,a=n.x,o=-n.y,c=this.left.activeId!==null||this.right.activeId!==null||this.tiltActiveId!==null||this.pinchIds!==null||this.dropDown||this.dropPressedFrame,l={roll:a,pitch:o,yaw:s,throttle:r,drop:!1},h={cam:{tiltAxis:qs(this.tiltDeltaDegFrame),zoomAxis:qs(this.zoomDeltaFrame)},minimap:{zoomAxis:qs(this.zoomDeltaFrame)},actions:{drop:this.dropPressedFrame,restart:this.restartPressedFrame,toggleCam:this.toggleCamPressedFrame}};return this.dropPressedFrame=!1,this.restartPressedFrame=!1,this.toggleCamPressedFrame=!1,this.tiltDeltaDegFrame=0,this.zoomDeltaFrame=0,{connected:e,active:c,frame:l,extras:h}}getCssPoint(e){const t=this.el.getBoundingClientRect();return{x:e.clientX-t.left,y:e.clientY-t.top}}getSize(){const e=this.el.getBoundingClientRect();return{w:e.width,h:e.height}}isInTiltStrip(e,t,n){const s=t*.22,r=(t-s)*.5,a=r+s,o=n*.12,c=n*.12;return e.x>=r&&e.x<=a&&e.y>=o&&e.y<=n-c}hitButton(e,t,n,s){const u=(t-388)*.5+s*134,d=n-18-58;return e.x>=u&&e.x<=u+120&&e.y>=d&&e.y<=d+58}tryStartPinch(){if(this.pinchIds||this.pointers.size<2)return;const t=Array.from(this.pointers.keys()).filter(n=>n!==this.left.activeId&&n!==this.right.activeId&&n!==this.tiltActiveId);t.length<2||(this.pinchIds=[t[0],t[1]],this.pinchDist0=Pl(this.pointers.get(t[0]).p,this.pointers.get(t[1]).p))}updatePinch(){if(!this.pinchIds)return;const e=this.pointers.get(this.pinchIds[0]),t=this.pointers.get(this.pinchIds[1]);if(!e||!t){this.pinchIds=null;return}const n=Pl(e.p,t.p);this.pinchDist0<=1e-6&&(this.pinchDist0=n);const s=n-this.pinchDist0;this.pinchDist0=n,this.zoomDeltaFrame+=s*ff}onDown=e=>{if(e.preventDefault(),!this.el)return;e.target.setPointerCapture?.(e.pointerId);const t=this.getCssPoint(e);this.pointers.set(e.pointerId,{id:e.pointerId,p:t});const{w:n,h:s}=this.getSize();if(this.hitButton(t,n,s,0)){this.restartDown=!0,this.restartPressedFrame=!0;return}if(this.hitButton(t,n,s,1)){this.dropDown=!0,this.dropPressedFrame=!0;return}if(this.hitButton(t,n,s,2)){this.camDown=!0,this.toggleCamPressedFrame=!0;return}if(this.isInTiltStrip(t,n,s)&&this.tiltActiveId===null){this.tiltActiveId=e.pointerId,this.tiltLastY=t.y;return}const r=72,a=s*.5,o={x:r,y:a},c={x:n-r,y:a};t.x<n*.5&&this.left.activeId===null?(this.left.activeId=e.pointerId,this.left.origin=o,this.leftStart=t,this.left.pos={x:0,y:0}):t.x>=n*.5&&this.right.activeId===null&&(this.right.activeId=e.pointerId,this.right.origin=c,this.rightStart=t,this.right.pos={x:0,y:0}),this.tryStartPinch()};onMove=e=>{e.preventDefault();const t=this.pointers.get(e.pointerId);if(t){if(t.p=this.getCssPoint(e),this.tiltActiveId===e.pointerId){const n=t.p.y-this.tiltLastY;this.tiltLastY=t.p.y,this.tiltDeltaDegFrame+=n*pf}this.left.activeId===e.pointerId?this.left.pos=Dl({x:t.p.x-this.leftStart.x,y:t.p.y-this.leftStart.y},Al):this.right.activeId===e.pointerId&&(this.right.pos=Dl({x:t.p.x-this.rightStart.x,y:t.p.y-this.rightStart.y},Al)),this.updatePinch()}};onUp=e=>{e.preventDefault(),this.pointers.delete(e.pointerId),this.left.activeId===e.pointerId&&(this.left.activeId=null,this.left.pos={x:0,y:0}),this.right.activeId===e.pointerId&&(this.right.activeId=null,this.right.pos={x:0,y:0}),this.tiltActiveId===e.pointerId&&(this.tiltActiveId=null),this.dropDown=!1,this.restartDown=!1,this.camDown=!1,this.pinchIds=null,this.pinchDist0=0,this.tryStartPinch()}}const Uc=new gf;function _f(i){Uc.attach(i)}function xf(){return Uc.snapshot()}function vf(){return Uc.getHudState()}function Ua(i){return Math.max(-1,Math.min(1,i))}class Mf{update(e){const t=lf(),n=uf(),s=df(),r=xf(),a=t.connected?t.extras.cam.tiltAxis??0:0,o=t.connected?t.extras.cam.zoomAxis??0:0,c=s.cam.tiltAxis??0,l=s.cam.zoomAxis??0,h=r.connected?r.extras.cam.tiltAxis??0:0,u=r.connected?r.extras.cam.zoomAxis??0:0,d=Ua(a+c+h),m=Ua(o+l+u),g=s.minimap.zoomAxis??0,_=r.connected?r.extras.minimap.zoomAxis??0:0,p=Ua(g+_),f={toggleCam:(t.connected?t.extras.actions.toggleCam:!1)||s.actions.toggleCam||(r.connected?r.extras.actions.toggleCam:!1),toggleDev:(t.connected?t.extras.actions.toggleDev:!1)||s.actions.toggleDev,restart:(t.connected?t.extras.actions.restart:!1)||s.actions.restart||(r.connected?r.extras.actions.restart:!1),drop:r.connected?r.extras.actions.drop:!1};let y=t.connected?"gamepad":"keyboard",b=t.connected?t.frame:n;return r.connected&&r.active&&(y="touch",b=r.frame),{source:y,raw:b,camAxes:{tiltAxis:d,zoomAxis:m},minimapAxes:{zoomAxis:p},actions:f,touchHud:r.connected?vf():void 0,gamepad:{connected:t.connected,id:t.connected?t.gamepadId:"no gamepad",index:t.connected?t.gamepadIndex:-1,rcRaw:t.connected?t.rcRaw:{roll:0,pitch:0,yaw:0,thr:0}}}}}function ha(){return{roll:0,pitch:0,yaw:0,throttle:0,drop:!1}}function bn(i,e,t){return Math.max(e,Math.min(t,i))}function yf(i){return i<0?-1:1}function Fa(i,e){const t=bn(e,0,.95),n=Math.abs(i);if(n<=t)return 0;const s=(n-t)/(1-t);return yf(i)*s}function Oa(i,e){const t=bn(e,0,1),n=Math.abs(i),s=(1-t)*n+t*n*n*n;return i<0?-s:s}function Sf(i,e,t){const n=bn(e,0,.99),s=Oa(Fa(bn(i.roll,-1,1),n),t),r=Oa(Fa(bn(i.pitch,-1,1),n),t),a=Oa(Fa(bn(i.yaw,-1,1),n),t),o=bn(i.throttle,-1,1);return{roll:bn(s,-1,1),pitch:bn(r,-1,1),yaw:bn(a,-1,1),throttle:o,drop:!!i.drop}}class bf{constructor(e){this.cfg=e}raw=ha();frame=ha();prevDropDown=!1;update(){const e=Sf(this.raw,this.cfg.deadzone,this.cfg.expo),t=!!this.raw.drop,n=t&&!this.prevDropDown;this.prevDropDown=t,e.drop=n,this.frame=e}getFrame(){return this.frame}setRaw(e){this.raw=e}}function Ll(i){return i=i%360,i<0&&(i+=360),i}function Ef(i){return i=i%360,i>180&&(i-=360),i<-180&&(i+=360),i}function wu(i){const e=i.targetPos.x-i.dronePos.x,t=i.targetPos.z-i.dronePos.z,n=Math.hypot(e,t),s=i.wind.x,r=i.wind.z,a=Math.hypot(s,r),o=Math.hypot(i.droneVel.x,i.droneVel.z),c=i.droneVel.x+s,l=i.droneVel.z+r,h=Math.hypot(c,l),u=Math.atan2(s,-r),d=Ll(u*180/Math.PI),m=Ll(i.droneRot.yaw*180/Math.PI),g=Ef(d-m),_=i.payloads??[],p=_.some(y=>!!y&&y.active),f=_.length>0&&_.every(y=>!!y&&y.landed);return{distToTargetM:n,windSpeedMps:a,windAzimuthDeg:d,windRelDeg:g,airSpeedMps:o,groundSpeedMps:h,yawDeg:m,gustCount:i.gusts.length,payloadActive:p,payloadLanded:f}}function Au(i,e){if(!Number.isFinite(i)||!Number.isFinite(e)||e<=0)return 1;const t=i*Math.PI/180,n=e*Math.PI/180;return Math.tan(t*.5)/Math.tan(n*.5)}function ei(i){return(typeof i=="number"&&Number.isFinite(i)?i:0).toFixed(3).padStart(7," ")}function Nl(i,e=42){const t=typeof i=="string"?i:"";return t.length>e?t.slice(0,e-1)+"…":t}function fr(i,e,t="--"){return typeof i!="number"||!Number.isFinite(i)?t:i.toFixed(e)}function pr(i){return i.toFixed(0)}function cn(i){return i.toFixed(1)}function bs(i){return i.toFixed(2)}function Tf(i,e){return(Math.atan2(i,e)*180/Math.PI+360)%360}function wf(i){const e=[0,3,1,2];for(let t=0;t<e.length;t++){const n=e[t];if(n<i.length&&i[n]>1e-6)return n}for(let t=0;t<i.length;t++)if(i[t]>1e-6)return t;return-1}function Af(i){return i.landed?"LANDED":i.active?"FALL":"OFF"}function Rf(i,e,t){return Math.sqrt(i*i+e*e+t*t)}class Cf{constructor(e,t){this.el=e,this.config=t,this.applyVisibility()}config;enabled=!0;fps=0;lastNow=0;setEnabled(e){this.enabled=e,this.applyVisibility()}toggle(){this.enabled=!this.enabled,this.applyVisibility()}render(e,t){if(!this.enabled)return;if(typeof t=="number"){if(this.lastNow>0){const M=1e3/Math.max(1,t-this.lastNow);this.fps=this.fps<=0?M:this.fps*.9+M*.1}this.lastNow=t}const n=e.gamepadId??"no gamepad",s=Number.isFinite(e.gamepadIndex)?e.gamepadIndex:-1,r=e.rcRaw,a=e.rc,o=e.camera?.combatPitchDeg,c=Au(this.config.render.cameras.combat.fovDegDefault,e.camera?.combatFow),l=wu(e),h=e.dronePos.x,u=e.dronePos.y,d=e.dronePos.z,m=e.targetPos.x-h,g=e.targetPos.z-d,_=Tf(m,g),p=e.presetName??"default",f=e.payloadSlotsKg??[],y=wf(f),b=[];for(let x=0;x<4;x++){const M=f[x]??0,P=M>1e-6,N=P?"READY":"EMPTY",U=x===y?" <- next":"";b.push(`  slot${x}: ${N} ${P?`(${bs(M)}kg)`:""}${U}`.trimEnd())}const S=e.payloadImpacts??[],T=new Map;for(let x=0;x<S.length;x++){const M=S[x];T.set(M.payloadId,M)}const w=e.payloads??[],R=[];if(!w.length)R.push("  (no dropped payloads)");else for(let x=0;x<w.length;x++){const M=w[x],P=Af(M),N=M.pos.x,U=M.pos.y,O=M.pos.z,V=M.vel.x,k=M.vel.y,G=M.vel.z,K=T.get(M.id)??null,ne=K?` miss:${cn(K.missM)}m`:"";R.push(`  #${M.id} ${P}  pos(${cn(N)},${cn(U)},${cn(O)})  vel(${cn(V)},${cn(k)},${cn(G)})${ne}`)}const C=Rf(e.droneCtrlAcc.x,e.droneCtrlAcc.y,e.droneCtrlAcc.z);this.el.textContent=`DEV OVERLAY (Z)
preset: ${Nl(p)}
...
wind: ${bs(l.windSpeedMps)} m/s  az: ${pr(l.windAzimuthDeg)}°  rel: ${pr(l.windRelDeg)}°
air:  ${bs(l.airSpeedMps)} m/s
gnd:  ${bs(l.groundSpeedMps)} m/s

yaw: ${pr(l.yawDeg)}°   gusts: ${l.gustCount}
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Uh(){return new Nn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Aa(),fragmentShader:`
		...
		`,blending:Kn,depthTest:!1,depthWrite:!1})}function Fh(){return new Nn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Aa(),fragmentShader:`
	...
	`}function ux(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const c=o.mapping,l=c===da||c===Ho,h=c===Di||c===os;if(l||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Tc(i)),u=l?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const m=o.image;return l&&m&&m.height>0||h&&m&&s(m)?(t===null&&(t=new Tc(i)),u=l?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let c=0;const l=6;for(let h=0;h<l;h++)o[h]!==void 0&&c++;return c===l}function r(o){const c=o.target;c.removeEventListener("dispose",r);const l=e.get(c);l!==void 0&&(e.delete(c),l.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function dx(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&sr("WebGLRenderer: "+n+" extension not supported."),s}}}function fx(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete s[d.id];const m=r.get(d);m&&(e.remove(m),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function c(u){const d=u.attributes;for(const m in d)e.update(d[m],i.ARRAY_BUFFER)}function l(u){const d=[],m=u.index,g=u.attributes.position;let _=0;if(m!==null){const y=m.array;_=m.version;for(let b=0,S=y.length;b<S;b+=3){const T=y[b+0],w=y[b+1],R=y[b+2];d.push(T,w,w,R,R,T)}}else if(g!==void 0){const y=g.array;_=g.version;for(let b=0,S=y.length/3-1;b<S;b+=3){const T=b+0,w=b+1,R=b+2;d.push(T,w,w,R,R,T)}}else return;const p=new(Wu(d)?$u:Ku)(d,1);p.version=_;const f=r.get(u);f&&e.remove(f),r.set(u,p)}function h(u){const d=r.get(u);if(d){const m=u.index;m!==null&&d.version<m.version&&l(u)}else l(u);return r.get(u)}return{get:o,update:c,getWireframeAttribute:h}}function px(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function c(d,m){i.drawElements(n,m,r,d*a),t.update(m,n,1)}function l(d,m,g){g!==0&&(i.drawElementsInstanced(n,m,r,d*a,g),t.update(m,n,g))}function h(d,m,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,m,0,r,d,0,g);let p=0;for(let f=0;f<g;f++)p+=m[f];t.update(p,n,1)}function u(d,m,g,_){if(g===0)return;const p=e.get("WEBGL_multi_draw");if(p===null)for(let f=0;f<d.length;f++)l(d[f]/a,m[f],_[f]);else{p.multiDrawElementsInstancedWEBGL(n,m,0,r,d,0,_,0,g);let f=0;for(let y=0;y<g;y++)f+=m[y]*_[y];t.update(f,n,1)}}this.setMode=s,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function mx(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ce("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function gx(i,e,t){const n=new WeakMap,s=new dt;function r(a,o,c){const l=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let x=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",x)};d!==void 0&&d.texture.dispose();const m=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,_=o.morphAttributes.color!==void 0,p=o.morphAttributes.position||[],f=o.morphAttributes.normal||[],y=o.morphAttributes.color||[];let b=0;m===!0&&(b=1),g===!0&&(b=2),_===!0&&(b=3);let S=o.attributes.position.count*b,T=1;S>e.maxTextureSize&&(T=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const w=new Float32Array(S*T*4*u),R=new Xu(w,S,T,u);R.type=Bt,R.needsUpdate=!0;const C=b*4;for(let M=0;M<u;M++){const P=p[M],N=f[M],U=y[M],O=S*T*4*M;for(let V=0;V<P.count;V++){const k=V*C;m===!0&&(s.fromBufferAttribute(P,V),w[O+k+0]=s.x,w[O+k+1]=s.y,w[O+k+2]=s.z,w[O+k+3]=0),g===!0&&(s.fromBufferAttribute(N,V),w[O+k+4]=s.x,w[O+k+5]=s.y,w[O+k+6]=s.z,w[O+k+7]=0),_===!0&&(s.fromBufferAttribute(U,V),w[O+k+8]=s.x,w[O+k+9]=s.y,w[O+k+10]=s.z,w[O+k+11]=U.itemSize===4?s.w:1)}}d={count:u,texture:R,size:new Ne(S,T)},n.set(o,d),o.addEventListener("dispose",x)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let m=0;for(let _=0;_<l.length;_++)m+=l[_];const g=o.morphTargetsRelative?1:1-m;c.getUniforms().setValue(i,"morphTargetBaseInfluence",g),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function _x(i,e,t,n){let s=new WeakMap;function r(c){const l=n.render.frame,h=c.geometry,u=e.get(c,h);if(s.get(u)!==l&&(e.update(u),s.set(u,l)),c.isInstancedMesh&&(c.hasEventListener("dispose",o)===!1&&c.addEventListener("dispose",o),s.get(c)!==l&&(t.update(c.instanceMatrix,i.ARRAY_BUFFER),c.instanceColor!==null&&t.update(c.instanceColor,i.ARRAY_BUFFER),s.set(c,l))),c.isSkinnedMesh){const d=c.skeleton;s.get(d)!==l&&(d.update(),s.set(d,l))}return u}function a(){s=new WeakMap}function o(c){const l=c.target;l.removeEventListener("dispose",o),t.remove(l.instanceMatrix),l.instanceColor!==null&&t.remove(l.instanceColor)}return{update:r,dispose:a}}const xx={[Bc]:"LINEAR_TONE_MAPPING",[kc]:"REINHARD_TONE_MAPPING",[zc]:"CINEON_TONE_MAPPING",[Vc]:"ACES_FILMIC_TONE_MAPPING",[Iu]:"AGX_TONE_MAPPING",[Lu]:"NEUTRAL_TONE_MAPPING",[Du]:"CUSTOM_TONE_MAPPING"};function vx(i,e,t,n,s){const r=new In(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new In(e,t,{type:Qt,depthBuffer:!1,stencilBuffer:!1}),o=new Yt;o.setAttribute("position",new Xt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Xt([0,2,0,0,2,0],2));const c=new zm({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Pt(o,c),h=new wa(-1,1,1,-1,0,1);let u=null,d=null,m=!1,g,_=null,p=[],f=!1;this.setSize=function(y,b){r.setSize(y,b),a.setSize(y,b);for(let S=0;S<p.length;S++){const T=p[S];T.setSize&&T.setSize(y,b)}},this.setEffects=function(y){p=y,f=p.length>0&&p[0].isRenderPass===!0;const b=r.width,S=r.height;for(let T=0;T<p.length;T++){const w=p[T];w.setSize&&w.setSize(b,S)}},this.begin=function(y,b){if(m||y.toneMapping===_n&&p.length===0)return!1;if(_=b,b!==null){const S=b.width,T=b.height;(r.width!==S||r.height!==T)&&this.setSize(S,T)}return f===!1&&y.setRenderTarget(r),g=y.toneMapping,y.toneMapping=_n,!0},this.hasRenderPass=function(){return f},this.end=function(y,b){y.toneMapping=g,m=!0;let S=r,T=a;for(let w=0;w<p.length;w++){const R=p[w];if(R.enabled!==!1&&(R.render(y,T,S,b),R.needsSwap!==!1)){const C=S;S=T,T=C}}if(u!==y.outputColorSpace||d!==y.toneMapping){u=y.outputColorSpace,d=y.toneMapping,c.defines={},Ye.getTransfer(u)===tt&&(c.defines.SRGB_TRANSFER="");const w=xx[d];w&&(c.defines[w]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=S.texture,y.setRenderTarget(_),y.render(l,h),_=null,m=!1},this.isCompositing=function(){return m},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),c.dispose()}}const dd=new yt,wc=new or(1,1),fd=new Xu,pd=new om,md=new Ju,Oh=[],Bh=[],kh=new Float32Array(16),zh=new Float32Array(9),Vh=new Float32Array(4);function ys(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Oh[s];if(r===void 0&&(r=new Float32Array(s),Oh[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function St(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function bt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Ra(i,e){let t=Bh[e];t===void 0&&(t=new Int32Array(e),Bh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function Mx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function yx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2fv(this.addr,e),bt(t,e)}}function Sx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(St(t,e))return;i.uniform3fv(this.addr,e),bt(t,e)}}function bx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4fv(this.addr,e),bt(t,e)}}function Ex(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),bt(t,e)}else{if(St(t,n))return;Vh.set(n),i.uniformMatrix2fv(this.addr,!1,Vh),bt(t,n)}}function Tx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),bt(t,e)}else{if(St(t,n))return;zh.set(n),i.uniformMatrix3fv(this.addr,!1,zh),bt(t,n)}}function wx(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(St(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),bt(t,e)}else{if(St(t,n))return;kh.set(n),i.uniformMatrix4fv(this.addr,!1,kh),bt(t,n)}}function Ax(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Rx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2iv(this.addr,e),bt(t,e)}}function Cx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3iv(this.addr,e),bt(t,e)}}function Px(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4iv(this.addr,e),bt(t,e)}}function Dx(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function Ix(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(St(t,e))return;i.uniform2uiv(this.addr,e),bt(t,e)}}function Lx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(St(t,e))return;i.uniform3uiv(this.addr,e),bt(t,e)}}function Nx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(St(t,e))return;i.uniform4uiv(this.addr,e),bt(t,e)}}function Ux(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(wc.compareFunction=t.isReversedDepthBuffer()?Zc:$c,r=wc):r=dd,t.setTexture2D(e||r,s)}function Fx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||pd,s)}function Ox(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||md,s)}function Bx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||fd,s)}function kx(i){switch(i){case 5126:return Mx;case 35664:return yx;case 35665:return Sx;case 35666:return bx;case 35674:return Ex;case 35675:return Tx;case 35676:return wx;case 5124:case 35670:return Ax;case 35667:case 35671:return Rx;case 35668:case 35672:return Cx;case 35669:case 35673:return Px;case 5125:return Dx;case 36294:return Ix;case 36295:return Lx;case 36296:return Nx;case 35678:case 36198:case 36298:case 36306:case 35682:return Ux;case 35679:case 36299:case 36307:return Fx;case 35680:case 36300:case 36308:case 36293:return Ox;case 36289:case 36303:case 36311:case 36292:return Bx}}function zx(i,e){i.uniform1fv(this.addr,e)}function Vx(i,e){const t=ys(e,this.size,2);i.uniform2fv(this.addr,t)}function Hx(i,e){const t=ys(e,this.size,3);i.uniform3fv(this.addr,t)}function Gx(i,e){const t=ys(e,this.size,4);i.uniform4fv(this.addr,t)}function Wx(i,e){const t=ys(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function Xx(i,e){const t=ys(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function Yx(i,e){const t=ys(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function qx(i,e){i.uniform1iv(this.addr,e)}function Kx(i,e){i.uniform2iv(this.addr,e)}function $x(i,e){i.uniform3iv(this.addr,e)}function Zx(i,e){i.uniform4iv(this.addr,e)}function jx(i,e){i.uniform1uiv(this.addr,e)}function Jx(i,e){i.uniform2uiv(this.addr,e)}function Qx(i,e){i.uniform3uiv(this.addr,e)}function ev(i,e){i.uniform4uiv(this.addr,e)}function tv(i,e,t){const n=this.cache,s=e.length,r=Ra(t,s);St(n,r)||(i.uniform1iv(this.addr,r),bt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=wc:a=dd;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function nv(i,e,t){const n=this.cache,s=e.length,r=Ra(t,s);St(n,r)||(i.uniform1iv(this.addr,r),bt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||pd,r[a])}function iv(i,e,t){const n=this.cache,s=e.length,r=Ra(t,s);St(n,r)||(i.uniform1iv(this.addr,r),bt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||md,r[a])}function sv(i,e,t){const n=this.cache,s=e.length,r=Ra(t,s);St(n,r)||(i.uniform1iv(this.addr,r),bt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||fd,r[a])}function rv(i){switch(i){case 5126:return zx;case 35664:return Vx;case 35665:return Hx;case 35666:return Gx;case 35674:return Wx;case 35675:return Xx;case 35676:return Yx;case 5124:case 35670:return qx;case 35667:case 35671:return Kx;case 35668:case 35672:return $x;case 35669:case 35673:return Zx;case 5125:return jx;case 36294:return Jx;case 36295:return Qx;case 36296:return ev;case 35678:case 36198:case 36298:case 36306:case 35682:return tv;case 35679:case 36299:case 36307:return nv;case 35680:case 36300:case 36308:case 36293:return iv;case 36289:case 36303:case 36311:case 36292:return sv}}class av{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=kx(t.type)}}class ov{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=rv(t.type)}}class cv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const Mo=/(\w+)(\])?(\[|\.)?/g;function Hh(i,e){i.seq.push(e),i.map[e.id]=e}function lv(i,e,t){const n=i.name,s=n.length;for(Mo.lastIndex=0;;){const r=Mo.exec(n),a=Mo.lastIndex;let o=r[1];const c=r[2]==="]",l=r[3];if(c&&(o=o|0),l===void 0||l==="["&&a+2===s){Hh(t,l===void 0?new av(o,i,e):new ov(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new cv(o),Hh(t,u)),t=u}}}class sa{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),c=e.getUniformLocation(t,o.name);lv(o,c,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],c=n[o.id];c.needsUpdate!==!1&&o.setValue(e,c.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Gh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const hv=37297;let uv=0;function dv(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Wh=new Oe;function fv(i){Ye._getMatrix(Wh,Ye.workingColorSpace,i);const e=`mat3( ${Wh.elements.map(t=>t.toFixed(4))} )`;switch(Ye.getTransfer(i)){case pa:return[e,"LinearTransferOETF"];case tt:return[e,"sRGBTransferOETF"];default:return Ee("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function Xh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+dv(i.getShaderSource(e),o)}else return r}function pv(i,e){const t=fv(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const mv={[Bc]:"Linear",[kc]:"Reinhard",[zc]:"Cineon",[Vc]:"ACESFilmic",[Iu]:"AgX",[Lu]:"Neutral",[Du]:"Custom"};function gv(i,e){const t=mv[e];return t===void 0?(Ee("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const Xr=new I;function _v(){Ye.getLuminanceCoefficients(Xr);const i=Xr.x.toFixed(4),e=Xr.y.toFixed(4),t=Xr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function xv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ys).join(`
`)}function vv(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Mv(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function Ys(i){return i!==""}function Yh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function qh(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const yv=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ac(i){return i.replace(yv,bv)}const Sv=new Map;function bv(i,e){let t=Be[e];if(t===void 0){const n=Sv.get(e);if(n!==void 0)t=Be[n],Ee('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Ac(t)}const Ev=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Kh(i){return i.replace(Ev,Tv)}function Tv(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function $h(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const wv={[Ks]:"SHADOWMAP_TYPE_PCF",[ts]:"SHADOWMAP_TYPE_VSM"};function Av(i){return wv[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Rv={[Di]:"ENVMAP_TYPE_CUBE",[os]:"ENVMAP_TYPE_CUBE",[ya]:"ENVMAP_TYPE_CUBE_UV"};function Cv(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Rv[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Pv={[os]:"ENVMAP_MODE_REFRACTION"};function Dv(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Pv[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Iv={[Pu]:"ENVMAP_BLENDING_MULTIPLY",[bp]:"ENVMAP_BLENDING_MIX",[Ep]:"ENVMAP_BLENDING_ADD"};function Lv(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Iv[i.combine]||"ENVMAP_BLENDING_NONE"}function Nv(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Uv(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const c=Av(t),l=Cv(t),h=Dv(t),u=Lv(t),d=Nv(t),m=xv(t),g=vv(r),_=s.createProgram();let p,f,y=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+f);const b=y+p+a,S=y+f+o,T=Gh(s,s.VERTEX_SHADER,b),w=Gh(s,s.FRAGMENT_SHADER,S);s.attachShader(_,T),s.attachShader(_,w),t.index0AttributeName!==void 0?s.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(_,0,"position"),s.linkProgram(_);function R(P){if(i.debug.checkShaderErrors){const N=s.getProgramInfoLog(_)||"",U=s.getShaderInfoLog(T)||"",O=s.getShaderInfoLog(w)||"",V=N.trim(),k=U.trim(),G=O.trim();let K=!0,ne=!0;if(s.getProgramParameter(_,s.LINK_STATUS)===!1)if(K=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,_,T,w);else{const ee=Xh(s,T,"vertex"),he=Xh(s,w,"fragment");Ce("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(_,s.VALIDATE_STATUS)+`
...
`;continue}if((k=V.match(M))&&(O.gamma=parseFloat(k[1])),(k=V.match(P))&&(O.exposure=parseFloat(k[1])),(k=V.match(N))&&(O.valid|=2,O.format=k[1]),(k=V.match(U))&&(O.valid|=4,O.height=parseInt(k[1],10),O.width=parseInt(k[2],10)),O.valid&2&&O.valid&4)break}return O.valid&2||a(3,"missing format specifier"),O.valid&4||a(3,"missing image size specifier"),O},m=function(C,x,M){const P=x;if(P<8||P>32767||C[0]!==2||C[1]!==2||C[2]&128)return new Uint8Array(C);P!==(C[2]<<8|C[3])&&a(3,"wrong scanline width");const N=new Uint8Array(4*x*M);N.length||a(4,"unable to allocate buffer space");let U=0,O=0;const V=4*P,k=new Uint8Array(4),G=new Uint8Array(V);let K=M;for(;K>0&&O<C.byteLength;){O+4>C.byteLength&&a(1),k[0]=C[O++],k[1]=C[O++],k[2]=C[O++],k[3]=C[O++],(k[0]!=2||k[1]!=2||(k[2]<<8|k[3])!=P)&&a(3,"bad rgbe scanline format");let ne=0,ee;for(;ne<V&&O<C.byteLength;){ee=C[O++];const Ae=ee>128;if(Ae&&(ee-=128),(ee===0||ne+ee>V)&&a(3,"bad scanline data"),Ae){const Re=C[O++];for(let ot=0;ot<ee;ot++)G[ne++]=Re}else G.set(C.subarray(O,O+ee),ne),ne+=ee,O+=ee}const he=P;for(let Ae=0;Ae<he;Ae++){let Re=0;N[U]=G[Ae+Re],Re+=P,N[U+1]=G[Ae+Re],Re+=P,N[U+2]=G[Ae+Re],Re+=P,N[U+3]=G[Ae+Re],U+=4}K--}return N},g=function(C,x,M,P){const N=C[x+3],U=Math.pow(2,N-128)/255;M[P+0]=C[x+0]*U,M[P+1]=C[x+1]*U,M[P+2]=C[x+2]*U,M[P+3]=1},_=function(C,x,M,P){const N=C[x+3],U=Math.pow(2,N-128)/255;M[P+0]=Er.toHalfFloat(Math.min(C[x+0]*U,65504)),M[P+1]=Er.toHalfFloat(Math.min(C[x+1]*U,65504)),M[P+2]=Er.toHalfFloat(Math.min(C[x+2]*U,65504)),M[P+3]=Er.toHalfFloat(1)},p=new Uint8Array(e);p.pos=0;const f=d(p),y=f.width,b=f.height,S=m(p.subarray(p.pos),y,b);let T,w,R;switch(this.type){case Bt:R=S.length/4;const C=new Float32Array(R*4);for(let M=0;M<R;M++)g(S,M*4,C,M*4);T=C,w=Bt;break;case Qt:R=S.length/4;const x=new Uint16Array(R*4);for(let M=0;M<R;M++)_(S,M*4,x,M*4);T=x,w=Qt;break;default:throw new Error("THREE.HDRLoader: Unsupported type: "+this.type)}return{width:y,height:b,data:T,header:f.string,gamma:f.gamma,exposure:f.exposure,type:w}}setDataType(e){return this.type=e,this}load(e,t,n,s){function r(a,o){switch(a.type){case Bt:case Qt:a.colorSpace=Rt,a.minFilter=je,a.magFilter=je,a.generateMipmaps=!1,a.flipY=!0;break}t&&t(a,o)}return super.load(e,r,n,s)}}class Uy extends Ny{constructor(e){console.warn("RGBELoader has been deprecated. Please use HDRLoader instead."),super(e)}}function Fy(i){const e=i.originX,t=i.originX+(i.nx-1)*i.cellM,n=i.originZ,s=i.originZ+(i.nz-1)*i.cellM,r=i.cellM;return{sampler:{getHeight:(a,o)=>vd(i,a,o)},bounds:{minX:e,maxX:t,minZ:n,maxZ:s},cellM:r,clearanceM:r,maxClimbM:r*.6}}function Oy(i){switch(i){case"Basic":return sp;case"PCF":return Ks;case"PCFSoft":return Cu;case"VSM":return ts}}function By(i){return i==="SRGB"?gt:Rt}function ky(i){switch(i){case"None":return _n;case"Linear":return Bc;case"Reinhard":return kc;case"Cineon":return zc;case"ACESFilmic":return Vc}}function zy(i,e,t){const n=t.render?.renderer;n&&(typeof n.shadowMapEnabled=="boolean"&&(i.shadowMap.enabled=n.shadowMapEnabled),n.shadowMapType&&(i.shadowMap.type=Oy(n.shadowMapType)),n.outputColorSpace&&(i.outputColorSpace=By(n.outputColorSpace)),n.toneMapping&&(i.toneMapping=ky(n.toneMapping)),typeof n.toneMappingExposure=="number"&&(i.toneMappingExposure=n.toneMappingExposure));const s=t.render?.scene?.backgroundIntensity;typeof s=="number"&&(e.backgroundIntensity=s);const r=t.environment?.intensity;typeof r=="number"&&(e.environmentIntensity=r)}function Kr(i,e){const t=i.getObjectByName(e);if(!t)throw new Error(`Zone GLB: missing node "${e}"`);return t}function Vy(i,e=1e-4){return Math.abs(i.x)<e&&Math.abs(i.y)<e&&Math.abs(i.z)<e&&Math.abs(i.w-1)<e}function Hy(i){const e=Kr(i,"drone"),t=Kr(i,"target"),n=Kr(i,"sun"),s=Kr(i,"flyzone"),r=new I;e.getWorldPosition(r);const a=new I;t.getWorldPosition(a);const o=new Nt;t.getWorldQuaternion(o);const c=new I;n.getWorldPosition(c);const l=new Nt;n.getWorldQuaternion(l);const h=new I(0,0,-1).applyQuaternion(l).normalize(),u=new I;s.getWorldPosition(u);const d=new I;s.getWorldScale(d);const m=s.getWorldQuaternion(new Nt);if(!Vy(m))throw new Error('Zone GLB: "flyzone" must have no rotation (axis-aligned)');return{dronePos:r,targetPos:a,targetRot:o,sunPos:c,sunDir:h,fly:{center:u,halfX:d.x,halfY:d.y,halfZ:d.z}}}class Gy{constructor(e,t){this.r=e,this.scene=t,this.pmrem=new Tc(this.r)}config;markers;terrain=null;heightMap=null;root=null;sunLight=null;sunTarget=null;pmrem;envTex=null;gltfLoader=new gd;rgbeLoader=new Uy;async load(e){const t=`/maps/${e}`,n=`${t}/zone.json`,s=`${t}/terrain.glb`,r=`${t}/skybox.hdr`;this.dispose(!1);const a=await fetch(n);if(!a.ok)throw new Error(`Failed to load zone.json for "${e}"`);this.config=await a.json(),zy(this.r,this.scene,this.config);const o=await this.gltfLoader.loadAsync(s);this.root=o.scene,this.scene.add(this.root),this.markers=Hy(this.root),await this.applyHdrSkybox(r);try{const c=await Ey(`${t}/heights.bin`);this.heightMap=c,this.terrain=Fy(c),console.info(`[Zone] heights.bin loaded (${c.cellM}m grid)`)}catch{this.heightMap=null,this.terrain=null,console.info("[Zone] no heights.bin — flat terrain assumed")}this.setupSunLight()}disposeSun(){this.sunLight&&(this.scene.remove(this.sunLight),this.sunLight.dispose(),this.sunLight=null),this.sunTarget&&(this.scene.remove(this.sunTarget),this.sunTarget=null)}setupSunLight(){const e=this.config.sun;this.disposeSun();const t=new hd(16777215,e.intensity);t.castShadow=e.castShadow,t.position.copy(this.markers.sunPos);const n=new ft;n.position.set(0,0,0),this.scene.add(n),t.target=n,this.scene.add(t),n.updateMatrixWorld(!0),t.updateMatrixWorld(!0),this.sunLight=t,this.sunTarget=n}async applyHdrSkybox(e){this.envTex&&(this.scene.background===this.envTex&&(this.scene.background=null),this.scene.environment===this.envTex&&(this.scene.environment=null),this.envTex.dispose(),this.envTex=null);const t=await this.rgbeLoader.loadAsync(e);t.mapping=da,t.colorSpace=Rt;const n=this.pmrem.fromEquirectangular(t).texture;this.envTex=n,this.scene.background=n,this.scene.environment=n,t.dispose()}resetForReload(){this.dispose(!1)}dispose(e=!0){this.disposeSun(),this.terrain=null,this.heightMap=null,this.root&&(this.scene.remove(this.root),this.root.traverse(t=>{const n=t;if(!n.isMesh)return;n.geometry&&n.geometry.dispose();const s=n.material;Array.isArray(s)?s.forEach(r=>r.dispose()):s&&s.dispose()}),this.root=null),this.envTex&&(this.scene.background===this.envTex&&(this.scene.background=null),this.scene.environment===this.envTex&&(this.scene.environment=null),this.envTex.dispose(),this.envTex=null),e&&this.pmrem.dispose()}}class Wy{constructor(e,t){this.r=e,this.scene=t}zone=null;loadSeq=0;get activeZone(){return this.zone}get activeZoneConfig(){return this.zone?.config??null}get dronePos(){return this.zone?.markers?.dronePos??null}get targetPos(){return this.zone?.markers?.targetPos??null}get targetRot(){return this.zone?.markers?.targetRot??null}get sunDir(){return this.zone?.markers?.sunDir??null}get flyzone(){return this.zone?.markers?.fly??null}async setZone(e){const t=++this.loadSeq,n=new Gy(this.r,this.scene);if(await n.load(e),t!==this.loadSeq)return n.dispose(),null;this.zone?.dispose(),this.zone=n}clear(){this.loadSeq++,this.zone?.dispose(),this.zone=null}}function An(i=0,e=0,t=0){return{x:i,y:e,z:t}}function Xy(i,e){const t=Math.hypot(i.x,i.z);if(t<=e||t<1e-8)return i;const n=e/t;return{x:i.x*n,y:i.y,z:i.z*n}}function Yy(i,e,t){if(i.t=0,i.bounds=e?{minX:e.fly.center.x-e.fly.halfX,maxX:e.fly.center.x+e.fly.halfX,minY:e.fly.center.y-e.fly.halfY,maxY:e.fly.center.y+e.fly.halfY,minZ:e.fly.center.z-e.fly.halfZ,maxZ:e.fly.center.z+e.fly.halfZ}:null,i.terrain=t??null,e?(i.dronePos=An(e.dronePos.x,e.dronePos.y,e.dronePos.z),i.targetPos=An(e.targetPos.x,e.targetPos.y,e.targetPos.z),i.targetRot={x:e.targetRot.x,y:e.targetRot.y,z:e.targetRot.z,w:e.targetRot.w}):(i.dronePos=An(0,0,0),i.targetPos=An(80,0,-80),i.targetRot={x:0,y:0,z:0,w:1}),i.terrain){const n=i.terrain.sampler.getHeight(i.dronePos.x,i.dronePos.z);if(n!==null){const s=n+i.terrain.clearanceM;i.dronePos.y<s&&(i.dronePos.y=s)}}i.droneVel=An(0,0,0),i.droneRot={pitch:0,yaw:0,roll:0},i.droneCtrlAcc=An(0,0,0),i.droneYawVel=0,i.trail.length=0}function uu(i){return Math.max(-1,Math.min(1,i))}function qy(i){return Math.max(0,Math.min(.05,i))}class Ky{constructor(e,t){this.canvas=e,this.cfg=t;const{r:n,scene:s}=this.createScene(e,t);this.r=n,this.scene=s,this.zones=new Wy(this.r,this.scene),this.cams=wM(t,this.r,this.canvas),this.activeCam=this.cams.combat.cam,this.droneRig=NM(),this.scene.add(this.droneRig.root),this.payloadRig=My(),this.scene.add(this.payloadRig.droppedRoot),this.payloadRig.setDroneMountParent(this.droneRig.modelPivot),this.scene.add(this.cams.combat.cam),this.scene.add(this.cams.dev.cam),this.vfx=new Ly(s),this.setCameraMode(fn.COMBAT),this.resize(),this.loadAssetsFromCatalog()}r;scene;zones;cams;activeCam;mode=fn.COMBAT;droneRig;payloadRig;targetMarker=null;extrasInput={tiltAxis:0,zoomAxis:0};lastNowMs=null;catalog=new my;vfx;isReady=!1;onReady=null;createScene(e,t){const n=new fM({canvas:e,antialias:!0});n.setPixelRatio(Math.min(t.render.pixelRatioCap,Math.max(1,window.devicePixelRatio||1)));const s=new Rm;return{r:n,scene:s}}async loadAssetsFromCatalog(){try{await this.catalog.load("models/assets.glb");const e=this.catalog.spawn("drone",{parent:this.droneRig.modelPivot,visible:!0});this.droneRig.setModel(e);const t=e.getObjectByName("camera");this.cams.combat.setMountParent(t??this.droneRig.modelPivot),t||console.warn("Drone model missing camera mount");const n=this.catalog.spawn("payload",{parent:this.payloadRig.droppedRoot,visible:!1});this.payloadRig.setTemplate(n);const s=this.catalog.spawn("target",{parent:this.scene,visible:!0});this.targetMarker=s}catch{this.droneRig.setModel(null),this.payloadRig.setTemplate(null);const e=yy(0,65280);e.visible=!1,this.scene.add(e),this.targetMarker=e}finally{this.isReady=!0,this.onReady?.()}}async setZone(e,t){await this.zones.setZone(e);const n=this.zones.activeZone;Yy(t,n?.markers,n?.terrain),this.vfx.setHeightMap(n?.heightMap??null),this.vfx.reset()}setOnReady(e){if(this.isReady){e();return}this.onReady=e}setCameraMode(e){this.mode=e,this.activeCam=e===fn.COMBAT?this.cams.combat.cam:this.cams.dev.cam,this.cams.combat.setEnabled(e===fn.COMBAT),this.extrasInput.tiltAxis=0,this.extrasInput.zoomAxis=0}resetCamera(){this.setCameraMode(fn.COMBAT),this.cams.combat?.reset?.(),this.cams.dev?.reset?.()}cycleCameraMode(){this.setCameraMode(this.mode===fn.COMBAT?fn.DEV:fn.COMBAT)}setCameraAxes(e){this.extrasInput.tiltAxis=uu(e.tiltAxis),this.extrasInput.zoomAxis=uu(e.zoomAxis)}render(e,t){let n=.016666666666666666;this.lastNowMs!==null&&(n=(t-this.lastNowMs)/1e3),this.lastNowMs=t,n=qy(n),this.droneRig.spinHubs(n),this.droneRig.applyWorldPose(e),this.payloadRig.syncFromWorld(e),Sy(this.targetMarker,e),this.mode===fn.COMBAT?(this.cams.combat.update(e,this.cfg,this.extrasInput,n),e.camera.combatPitchDeg=this.cams.combat.state.tiltDeg,e.camera.combatFow=this.cams.combat.state.fovDeg):this.cams.dev.update(e,this.cfg,n),this.vfx.update(e,n),this.r.render(this.scene,this.activeCam)}resize(){const e=this.canvas.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height));if(this.canvas.width===t&&this.canvas.height===n)return;this.r.setSize(t,n,!1);const s=t/n;this.cams.combat.cam.aspect=s,this.cams.dev.cam.aspect=s,this.cams.combat.cam.updateProjectionMatrix(),this.cams.dev.cam.updateProjectionMatrix()}}const $y={fixedDt:1/60,seed:12345},Zy={pixelRatioCap:2,axes:{flipX:!0},backgroundColorHex:14540253,cameras:{combat:{near:.1,far:12e3,fovDegDefault:80,lookAheadM:6,pitchDegDefault:0,pitchMinDeg:0,pitchMaxDeg:89.99},dev:{fovDeg:80,near:.1,far:12e3,distM:5,elevDeg:45}}},jy={field:{size:1e4,tile:100,padding:4e3},target:{position:{x:80,y:0,z:-80}},bounds:{mode:"clamp",killOutwardVel:!0},drone:{maxSpeedMps:25,yawRateRadPerSec:Math.PI*2,yawAccelRadPerSec2:24,yawDampingPerSec:2,altitude:{maxClimbMps:6,maxDescentMps:4,responsePerSec:16,dampingPerSec:8},attitude:{maxPitchRad:Math.PI/6,maxRollRad:Math.PI/6,responseRadPerSec:1,timeToMaxSpeedSec:2,dampingPerSec:1.5}},payload:{droneDryMassKg:15,slotsKg:[3,3,3,3],controlMaxForceN:120,gravityMps2:9.81,dragKxz:.05,dragKy:.04,pitchOmegaRad:10,pitchDamp:8},wind:{enabled:!0,dirRad:Math.PI*.25,speedMps:5,varPeriodSec:8,speedJitterMps:2.5,dirJitterRad:Math.PI/10},gust:{enabled:!0,spawnPeriodSec:6,spawnJitterSec:3,durationSec:3,durationJitterSec:1.5,radiusM:45,radiusJitterM:25,peakMps:10,peakJitterMps:6,dirJitterRad:Math.PI/4,maxActive:6,centerJitterM:80}},Ca=[{id:"kazhan",name:"Kazhan E360",override:{drone:{maxSpeedMps:25,yawRateRadPerSec:Math.PI*1.4,altitude:{maxClimbMps:6,maxDescentMps:4,responsePerSec:6,dampingPerSec:1.2},attitude:{responseRadPerSec:1,timeToMaxSpeedSec:2,dampingPerSec:1.6}}}},{id:"pegas",name:"Pegasus PA25",override:{drone:{yawRateRadPerSec:Math.PI*1,altitude:{maxClimbMps:2.5,maxDescentMps:2,responsePerSec:4,dampingPerSec:2},attitude:{responseRadPerSec:.5,timeToMaxSpeedSec:3,dampingPerSec:2.5}}}},{id:"mavic",name:"Mavic 3",override:{drone:{yawRateRadPerSec:Math.PI*1.9,altitude:{maxClimbMps:6,maxDescentMps:4.5,responsePerSec:10,dampingPerSec:.8},attitude:{responseRadPerSec:2,timeToMaxSpeedSec:1,dampingPerSec:1}}}}],Md=new Map(Ca.map(i=>[i.id,i]));function yd(i){return Md.has(i)}function Jy(i){return Md.get(i)??Ca[0]}function Qy(i,e){return{bounds:{...i.bounds,...e.bounds??{}},field:{...i.field,...e.field??{}},target:{...i.target,...e.target??{},position:{...i.target.position,...e.target?.position??{}}},drone:{...i.drone,...e.drone??{},altitude:{...i.drone.altitude,...e.drone?.altitude??{}},attitude:{...i.drone.attitude,...e.drone?.attitude??{}}},payload:{...i.payload,...e.payload??{}},wind:{...i.wind,...e.wind??{}},gust:{...i.gust,...e.gust??{}}}}const Sd="kd.scenario",bd="kd.wind",Ed="kd.zone",ll=Ca[0]?.id??"default",Td="snowy_mountain",Vs={dirDeg:45,speedMps:5,gustMaxMps:15,variation:.35,gustiness:.45};function ns(i,e,t){return Math.max(e,Math.min(t,i))}function wd(i){const e=i%360;return e<0?e+360:e}function du(i){return i*Math.PI/180}function Hs(i,e){const t=typeof i=="number"?i:Number(i);return Number.isFinite(t)?t:e}function eS(i){try{const e=localStorage.getItem(i);return e?JSON.parse(e):null}catch{return null}}function tS(i,e){localStorage.setItem(i,JSON.stringify(e))}function Ad(i){const e=i??{},t=!!e.enabled,n=wd(Math.round(Hs(e.dirDeg,Vs.dirDeg))),s=ns(Hs(e.speedMps,Vs.speedMps),0,50),r=ns(Hs(e.gustMaxMps,Vs.gustMaxMps),0,80),a=Math.max(r,s),o=ns(Hs(e.variation,Vs.variation),0,1),c=ns(Hs(e.gustiness,Vs.gustiness),0,1);return{enabled:t,dirDeg:n,speedMps:s,gustMaxMps:a,variation:o,gustiness:c}}function Rd(){const i=eS(bd);return Ad(i)}function nS(){const i=localStorage.getItem(Ed);return i&&typeof i=="string"&&i.length>0?i:Td}function iS(i,e){if(!e.enabled)return{...i,wind:{...i.wind,enabled:!1},gust:{...i.gust,enabled:!1}};const t=Math.max(0,e.speedMps),n=Math.max(t,e.gustMaxMps),s=Math.max(0,n-t),r=ns(e.variation,0,1),a=ns(e.gustiness,0,1),o=20-16*r,c=t*(.05+.6*r),l=du(2+28*r),h=10-8*a;return{...i,wind:{...i.wind,enabled:!0,dirRad:du(wd(e.dirDeg)),speedMps:t,varPeriodSec:Math.max(1,o),speedJitterMps:Math.max(0,c),dirJitterRad:Math.max(0,l)},gust:{...i.gust,enabled:s>0&&a>.01,peakMps:s,spawnPeriodSec:Math.max(.5,h)}}}let as=ll,hr=Pa(as);function Pa(i){const e=Jy(i);let t=Qy(jy,e.override);const n=Rd();return t=iS(t,n),{scenarioId:e.id,scenarioName:e.name,scenario:t,zoneId:nS(),core:{...$y},render:{...Zy},windUser:n}}function sS(){const i=localStorage.getItem(Sd),e=i&&yd(i)?i:ll;Pd(e)}function Cd(){return hr}function Ao(){return hr}function Pd(i){as=yd(i)?i:ll,hr=Pa(as),localStorage.setItem(Sd,as)}function rS(i){const e=Rd(),t=Ad({...e,...i});tS(bd,t),hr=Pa(as)}function aS(i){const e=(i||"").trim(),t=e.length>0?e:Td;localStorage.setItem(Ed,t),hr=Pa(as)}function Ci(i=0,e=0){return{x:i,z:e}}function Dd(i){const e=i.scenario,t=e.payload.slotsKg.slice(),n=t.reduce((a,o)=>a+o,0),s=e.payload.droneDryMassKg+n,r=e.target.position;return{t:0,terrain:null,bounds:null,presetName:i.scenarioName,dronePos:An(0,0,0),droneVel:An(0,0,0),droneRot:{pitch:0,yaw:0,roll:0},droneCtrlAcc:An(0,0,0),droneYawVel:0,camera:{combatPitchDeg:0,combatFow:0},wind:Ci(0,0),gusts:[],payloadSlotsKg:t,payloadNextId:1,payloads:[],payloadImpacts:[],totalMassKg:s,windScale:1,input:ha(),targetPos:An(r.x,r.y,r.z),targetRot:{x:0,y:0,z:0,w:1},trail:[],gamepadId:"no gamepad",gamepadIndex:-1,rcRaw:{roll:0,pitch:0,yaw:0,thr:0},rc:{roll:0,pitch:0,yaw:0,thr:0}}}function Ro(i,e,t){return Math.max(e,Math.min(t,i))}function oS(i,e,t){const n=Ro(i.x,t.minX,t.maxX),s=Ro(i.y,t.minY,t.maxY),r=Ro(i.z,t.minZ,t.maxZ);n!==i.x&&(i.x=n,e.x!==0&&(e.x=0)),s!==i.y&&(i.y=s,e.y!==0&&(e.y=0)),r!==i.z&&(i.z=r,e.z!==0&&(e.z=0))}function fu(i,e,t){return Math.max(e,Math.min(t,i))}function cS(i,e,t){const n=fu(i.x,t.minX,t.maxX),s=fu(i.z,t.minZ,t.maxZ);n!==i.x&&(i.x=n,e.x!==0&&(e.x=0)),s!==i.z&&(i.z=s,e.z!==0&&(e.z=0))}function lS(i,e,t,n){cS(i,e,n.bounds);const s=n.sampler.getHeight(t.x,t.z),r=n.sampler.getHeight(i.x,i.z);if(s!==null&&r!==null){r-s>n.maxClimbM&&(i.x=t.x,i.z=t.z,e.x=0,e.z=0);const a=n.sampler.getHeight(i.x,i.z);if(a!==null){const o=a+n.clearanceM;i.y<o&&(i.y=o,e.y<0&&(e.y=0))}}else i.x=t.x,i.z=t.z,e.x=0,e.z=0}function Si(i,e,t){return Math.max(e,Math.min(t,i))}function hS(i){const e=Math.PI*2;return i=(i+Math.PI)%e,i<0&&(i+=e),i-Math.PI}function $r(i,e,t){const n=e-i,s=Si(n,-t,t);return i+s}function uS(i,e,t){const n=Math.max(1e-6,t),s=e.scenario.drone,r=e.scenario.payload,a=s.altitude,o=Si(Number.isFinite(i.input.throttle)?i.input.throttle:0,-1,1),c=o>=0?o*a.maxClimbMps:o*a.maxDescentMps,l=Math.max(a.maxClimbMps,a.maxDescentMps),h=Math.max(0,a.responsePerSec)*l*n;i.droneVel.y=$r(i.droneVel.y,c,h);const d=1-Math.min(1,Math.abs(o)/.2),m=Math.max(0,a.dampingPerSec)*d,g=Math.exp(-m*n);i.droneVel.y*=g,i.dronePos.y+=i.droneVel.y*n;const _=Si(Number.isFinite(i.input.roll)?i.input.roll:0,-1,1),p=Si(Number.isFinite(i.input.pitch)?i.input.pitch:0,-1,1),f=Math.hypot(_,p),y=f>1?1/f:1,b=_*y,S=p*y,T=S*s.attitude.maxPitchRad,w=b*s.attitude.maxRollRad,R=Math.max(0,s.attitude.responseRadPerSec)*n;i.droneRot.pitch=$r(i.droneRot.pitch,T,R),i.droneRot.roll=$r(i.droneRot.roll,w,R);const C=Si(Number.isFinite(i.input.yaw)?i.input.yaw:0,-1,1),x=Math.max(0,s.yawRateRadPerSec),M=C*x,P=Math.max(1e-6,r.droneDryMassKg),N=Math.max(1e-6,Number.isFinite(i.totalMassKg)?i.totalMassKg:P),U=Si(P/N,.25,2),k=Math.max(0,s.yawAccelRadPerSec2)*U*n;i.droneYawVel=$r(Number.isFinite(i.droneYawVel)?i.droneYawVel:0,M,k);const K=Math.abs(C)<.05,ne=Math.max(0,s.yawDampingPerSec),he=1-.6*(x>1e-6?Si(Math.abs(i.droneYawVel)/x,0,1):0),Ae=ne*U*he;if(K&&Ae>0){const Re=Math.exp(-Ae*n);i.droneYawVel*=Re}return i.droneRot.yaw=hS(i.droneRot.yaw+i.droneYawVel*n),{stickRoll:b,stickPitch:S,stickMag:Math.hypot(b,S)}}function pu(i,e,t){return Math.max(e,Math.min(t,i))}function dS(i){let e=0;for(let t=0;t<i.length;t++)e+=i[t];return e}const fS=(i,e,t)=>{const n=Math.max(1e-6,t),s=e.scenario,r=dS(i.payloadSlotsKg??[]),a=Math.max(1e-6,s.payload.droneDryMassKg+r);i.totalMassKg=a,uS(i,e,n);const o=Math.max(1e-6,s.drone.attitude.timeToMaxSpeedSec),c=s.drone.maxSpeedMps/o,l=Math.max(0,s.payload.controlMaxForceN)/a,h=Math.min(c,l),u=s.drone.attitude.maxPitchRad>1e-6?pu(i.droneRot.pitch/s.drone.attitude.maxPitchRad,-1,1):0,m=(s.drone.attitude.maxRollRad>1e-6?pu(i.droneRot.roll/s.drone.attitude.maxRollRad,-1,1):0)*h,g=u*h,_=Math.cos(i.droneRot.yaw),p=Math.sin(i.droneRot.yaw),f=m*_+g*p,y=m*p-g*_,b=i.droneVel.x-i.wind.x,S=i.droneVel.z-i.wind.z,T=Math.hypot(b,S),w=Math.max(1e-6,s.drone.maxSpeedMps),R=Math.max(1e-6,s.payload.droneDryMassKg),C=Math.max(0,s.payload.controlMaxForceN)/R,M=Math.min(c,C)/(w*w),P=T>1e-9?-M*b*T:0,N=T>1e-9?-M*S*T:0;i.droneVel.x+=(f+P)*n,i.droneVel.z+=(y+N)*n,i.droneVel=Xy(i.droneVel,s.drone.maxSpeedMps);const U={x:i.dronePos.x,y:i.dronePos.y,z:i.dronePos.z};i.dronePos.x+=i.droneVel.x*n,i.dronePos.z+=i.droneVel.z*n,i.bounds&&oS(i.dronePos,i.droneVel,i.bounds);const O=i.terrain;O&&lS(i.dronePos,i.droneVel,U,O)};function pS(i,e){return Math.hypot(i.x-e.x,i.z-e.z)}const mS=(i=240,e=.5)=>t=>{const n=t.dronePos,s=t.trail.length?t.trail[t.trail.length-1]:void 0;(!s||pS(n,s)>=e)&&(t.trail.push({x:n.x,y:n.y,z:n.z}),t.trail.length>i&&t.trail.shift())};function gS(i){return Math.max(0,Math.min(1,i))}function Ai(i,e,t){return i+(e-i)*t}function _S(i){return i=gS(i),i*i*(3-2*i)}function mu(i){return i|=0,i=Math.imul(i^i>>>16,2146121005),i=Math.imul(i^i>>>15,2221713035),i=i^i>>>16,i>>>0}function Xn(i,e){return mu(i^mu(e))/4294967295}function gu(i,e,t,n=0){const s=Math.max(1e-6,t),r=e/s,a=Math.floor(r),o=a+1,c=Xn(i+n*1013,a),l=Xn(i+n*1013,o),h=_S(r-a);return Ai(c,l,h)}function Id(i){return{x:Math.sin(i),z:-Math.cos(i)}}function Ld(i){return Math.max(0,Math.min(1,i))}function xS(i,e){if(e<=1e-6)return 0;const t=Ld(i/e);return Math.sin(Math.PI*t)}function vS(i,e){if(e<=1e-6)return 0;const t=Ld(1-i/e);return t*t*(3-2*t)}function MS(i,e){return Math.hypot(i.x-e.x,i.z-e.z)}function yS(i,e,t,n){const s=gu(t.seed,i,n.varPeriodSec,1),r=gu(t.seed,i,n.varPeriodSec,2),a=n.speedMps+Ai(-n.speedJitterMps,n.speedJitterMps,s),o=n.dirRad+Ai(-n.dirJitterRad,n.dirJitterRad,r),c=Id(o);return Ci(c.x*a,c.z*a)}function SS(i,e,t){const n=e-i.startT;if(n<0||n>i.duration)return Ci(0,0);const s=MS(t,i.center);if(s>i.radius)return Ci(0,0);const r=xS(n,i.duration),a=vS(s,i.radius),o=i.peakMps*r*a,c=Id(i.dirRad);return Ci(c.x*o,c.z*o)}function bS(i,e,t,n,s){const r=n.wind,a=r.enabled?yS(i,e,t,r):Ci(0,0);let o=0,c=0;if(n.gust.enabled)for(const l of s){const h=SS(l,i,e);o+=h.x,c+=h.z}return Ci(a.x+o,a.z+c)}function ES(i,e,t,n,s){const r=n.gust,a=n.wind,o=Xn(t.seed+7001,s*5+0),c=Xn(t.seed+7001,s*5+1),l=Xn(t.seed+7001,s*5+2),h=Xn(t.seed+7001,s*5+3),u=Xn(t.seed+7001,s*5+4),d=r.durationSec+Ai(-r.durationJitterSec,r.durationJitterSec,o),m=r.radiusM+Ai(-r.radiusJitterM,r.radiusJitterM,c),g=r.peakMps+Ai(-r.peakJitterMps,r.peakJitterMps,l),_=a.dirRad+Ai(-r.dirJitterRad,r.dirJitterRad,h),p=u*Math.PI*2,f=r.centerJitterM*Math.sqrt(Xn(t.seed+7331,s)),y=e.x+Math.cos(p)*f,b=e.z+Math.sin(p)*f;return{id:s,startT:i,duration:Math.max(.25,d),center:{x:y,y:0,z:b},radius:Math.max(5,m),dirRad:_,peakMps:Math.max(0,g)}}function TS(i,e,t,n,s,r){const a=r.gust;if(!a.enabled){i.length=0;return}const o=Math.max(.25,a.spawnPeriodSec),c=Math.floor(t/o),l=Math.floor(e/o);c>l&&i.length<a.maxActive&&Xn(s.seed+9001,c)<.75&&i.push(ES(t,n,s,r,c));for(let h=i.length-1;h>=0;h--){const u=i[h];t>u.startT+u.duration&&i.splice(h,1)}}const wS=(i,e,t)=>{if(!e.scenario.wind.enabled){i.wind.x=0,i.wind.z=0,i.gusts.length=0;return}TS(i.gusts,i.t-t,i.t,i.dronePos,e.core,e.scenario),i.wind=bS(i.t,i.dronePos,e.core,e.scenario,i.gusts)};function Co(i,e,t){const n=i.getAttribute(t);n&&i.setAttribute(e,ke(n))}function Nd(i=document){(i.querySelectorAll?.("[data-i18n]")??[]).forEach(r=>{const a=r.getAttribute("data-i18n");a&&(r.textContent=ke(a))}),(i.querySelectorAll?.("[data-i18n-title]")??[]).forEach(r=>Co(r,"title","data-i18n-title")),(i.querySelectorAll?.("[data-i18n-aria-label]")??[]).forEach(r=>Co(r,"aria-label","data-i18n-aria-label")),(i.querySelectorAll?.("[data-i18n-alt]")??[]).forEach(r=>Co(r,"alt","data-i18n-alt"))}let hl="sim";function Gs(){return hl}function Ws(i){hl=i}function Ud(){return hl!=="sim"}function He(i){const e=document.querySelector(i);if(!e)throw new Error(`Missing DOM element: ${i}`);return e}function AS(i){return i<0?`AXIS ${Math.abs(i)}`:`BTN ${i}`}class RS{constructor(e){this.deps=e}back=He("#menu-back-gamepad");gpStatus=He("#gp-status");gpLive=He("#gp-live");gpPressed=He("#gp-pressed");gpBindings=He("#gp-bindings");gpHint=He("#gp-hint");gpSwap=He("#gp-swap-yaw-roll");gpSave=He("#gp-save");gpReset=He("#gp-reset");gpCalib=aa();gpId="gamepad";gpBindMode=null;gpRaf=null;gpIndex=null;ready=!1;bind(){this.back.addEventListener("click",()=>this.deps.openRoot()),this.gpSave.addEventListener("click",()=>this.gpDoSave()),this.gpReset.addEventListener("click",()=>this.gpDoReset()),this.gpSwap.addEventListener("change",()=>{this.gpCalib.swapYawRoll=this.gpSwap.checked,this.gpRenderBindings()})}onEnter(){this.stopLoop(),this.gpBindMode=null,this.gpIndex=null,this.ready=!1;const e=ef();e&&(this.gpId=e.id,this.gpCalib=e.calib,this.gpSwap.checked=!!this.gpCalib.swapYawRoll,this.gpRenderBindings()),this.gpStatus.textContent=ke("gp.waiting"),this.gpLive.textContent="",this.gpPressed.textContent="",this.gpHint.textContent="",this.startLoop()}onExit(){this.gpBindMode=null,this.gpIndex=null,this.ready=!1,this.stopLoop()}onEsc(){if(!this.gpBindMode)return!1;this.gpBindMode=null;const e=this.getActiveGamepad();return e&&Bn(e),this.gpHint.textContent=ke("common.canceled"),this.gpRenderBindings(),!0}startLoop(){if(this.gpRaf!=null)return;const e=()=>{this.update(),this.gpRaf=requestAnimationFrame(e)};this.gpRaf=requestAnimationFrame(e)}stopLoop(){this.gpRaf!=null&&cancelAnimationFrame(this.gpRaf),this.gpRaf=null}getActiveGamepad(){const e=navigator.getGamepads?.()??[],t=Array.from(e).filter(Boolean);if(this.gpIndex!=null){const n=t.find(s=>s.index===this.gpIndex);if(n)return n}return t[0]??null}ensureReady(e){this.ready||(this.gpIndex=e.index??null,this.gpId=tf(e),this.gpCalib=Nc(this.gpId)??aa(),this.gpSwap.checked=!!this.gpCalib.swapYawRoll,Bn(e),this.ready=!0,this.gpHint.textContent=ke("gp.hint_click_field"),this.gpRenderBindings())}update(){const e=this.getActiveGamepad();if(!e){this.gpStatus.textContent=ke("gp.no_gamepad"),this.gpPressed.textContent=ke("gp.btn_none");return}if(this.ensureReady(e),this.gpStatus.textContent=ke("gp.detected",{id:e.id||"gamepad",axes:e.axes.length,buttons:e.buttons.length}),this.gpBindMode)if(this.gpBindMode.kind==="axis"){const s=Sl(e);s!=null&&(this.gpCalib.axis[this.gpBindMode.key]=s,this.gpBindMode=null,this.gpHint.textContent=ke("gp.axis_captured"),this.gpRenderBindings(),Bn(e))}else if(this.gpBindMode.kind==="btn"){const s=rf(e);s!=null&&(this.gpCalib.buttons[this.gpBindMode.key]=s,this.gpBindMode=null,this.gpHint.textContent=ke("gp.button_captured"),this.gpRenderBindings(),Bn(e))}else{const s=Sl(e);s!=null&&(this.gpCalib.buttons[this.gpBindMode.key]=-s,this.gpBindMode=null,this.gpHint.textContent=ke("gp.axis_captured_for_action"),this.gpRenderBindings(),Bn(e))}const t=[];for(let s=0;s<(e.axes?.length??0);s++)t.push(ke("gp.axis_line",{i:String(s).padStart(2," "),v:Tn(e,s).toFixed(2)}));this.gpLive.textContent=t.join(`
`);const n=[];for(let s=0;s<(e.buttons?.length??0);s++)Ri(e,s)&&n.push(s);this.gpPressed.textContent=n.length?ke("gp.btn_list",{list:n.join(", ")}):ke("gp.btn_none")}startBindAxis(e){const t=this.getActiveGamepad();t&&Bn(t),this.gpBindMode={kind:"axis",key:e},this.gpHint.textContent=ke("gp.move_axis_for",{key:e}),this.gpRenderBindings()}startBindBtn(e){const t=this.getActiveGamepad();t&&Bn(t),this.gpBindMode={kind:"btn",key:e},this.gpHint.textContent=ke("gp.press_button_for",{key:e}),this.gpRenderBindings()}startBindBtnAxis(e){const t=this.getActiveGamepad();t&&Bn(t),this.gpBindMode={kind:"btnAxis",key:e},this.gpHint.textContent=ke("gp.move_axis_for_action",{key:e}),this.gpRenderBindings()}gpRenderBindings(){const e=this.gpCalib,t=[{kind:"axis",labelKey:"gp.bind.yaw",key:"yaw",inv:"yaw"},{kind:"axis",labelKey:"gp.bind.pitch",key:"pitch",inv:"pitch"},{kind:"axis",labelKey:"gp.bind.cam_tilt",key:"camTilt",inv:"camTilt"},{kind:"axis",labelKey:"gp.bind.throttle",key:"thr",inv:"thr"},{kind:"axis",labelKey:"gp.bind.roll",key:"roll",inv:"roll"},{kind:"axis",labelKey:"gp.bind.cam_zoom",key:"camZoom",inv:"camZoom"}],n=[{kind:"btn",labelKey:"gp.bind.drop",key:"drop"},{kind:"spacer"},{kind:"btn",labelKey:"gp.bind.toggle_cam",key:"toggleCam"},{kind:"btn",labelKey:"gp.bind.restart",key:"restart"},{kind:"spacer"},{kind:"btn",labelKey:"gp.bind.toggle_dev",key:"toggleDev"}],s=this.gpBindMode?.kind==="axis"?this.gpBindMode.key:null,r=this.gpBindMode?.kind==="btn"||this.gpBindMode?.kind==="btnAxis"?this.gpBindMode.key:null,a=t.map(c=>{if(c.kind==="spacer")return'<div class="gp-row gp-row--spacer"></div>';const l=e.axis[c.key],h=e.invert[c.inv],u=s===c.key;return`
<div class="gp-row">
...
`}).join("");this.gpBindings.innerHTML=a+`<div class="menu-note" style="margin-top:8px;">${ke("gp.buttons_header")}</div>`+o,this.gpBindings.querySelectorAll("[data-bind-axis]").forEach(c=>{c.addEventListener("click",()=>{const l=c.getAttribute("data-bind-axis");this.startBindAxis(l)})}),this.gpBindings.querySelectorAll("[data-bind-btn]").forEach(c=>{c.addEventListener("click",()=>{const l=c.getAttribute("data-bind-btn");this.startBindBtn(l)})}),this.gpBindings.querySelectorAll("[data-bind-btn-axis]").forEach(c=>{c.addEventListener("click",()=>{const l=c.getAttribute("data-bind-btn-axis");this.startBindBtnAxis(l)})}),this.gpBindings.querySelectorAll("[data-invert]").forEach(c=>{c.addEventListener("click",()=>{const l=c.getAttribute("data-invert");this.gpCalib.invert[l]*=-1,this.gpHint.textContent=ke("gp.invert_toggled"),this.gpRenderBindings()})})}gpDoSave(){nf(this.gpId,this.gpCalib),localStorage.setItem("kd:lastGamepadId",this.gpId),this.gpHint.textContent=ke("gp.saved")}gpDoReset(){this.gpCalib=sf(this.gpId),this.gpSwap.checked=!!this.gpCalib.swapYawRoll,this.gpBindMode=null,this.gpRenderBindings();const e=this.getActiveGamepad();e&&Bn(e),this.gpHint.textContent=ke("gp.reset_defaults")}}class CS{constructor(e){this.deps=e}back=He("#menu-back-keybinds");list=He("#kb-list");reset=He("#kb-reset");hint=He("#kb-hint");rebindId=null;rebindHandler=null;bind(){this.back.addEventListener("click",()=>this.deps.openRoot()),this.reset.addEventListener("click",()=>{hf(),this.render(),this.hint.textContent=ke("kb.reset_done")})}onEnter(){this.render()}onExit(){this.stopRebind()}onEsc(){return this.rebindHandler?(this.stopRebind(),this.hint.textContent=ke("common.canceled"),!0):!1}render(){const e=la(),t=[{kind:"bind",id:"throttleUp",labelKey:"kb.bind.throttleUp"},{kind:"bind",id:"yawLeft",labelKey:"kb.bind.yawLeft"},{kind:"bind",id:"pitchUp",labelKey:"kb.bind.pitchUp"},{kind:"bind",id:"throttleDown",labelKey:"kb.bind.throttleDown"},{kind:"bind",id:"yawRight",labelKey:"kb.bind.yawRight"},{kind:"bind",id:"pitchDown",labelKey:"kb.bind.pitchDown"},{kind:"bind",id:"rollLeft",labelKey:"kb.bind.rollLeft"},{kind:"bind",id:"camTiltUp",labelKey:"kb.bind.camTiltUp"},{kind:"bind",id:"camZoomIn",labelKey:"kb.bind.camZoomIn"},{kind:"bind",id:"rollRight",labelKey:"kb.bind.rollRight"},{kind:"bind",id:"camTiltDown",labelKey:"kb.bind.camTiltDown"},{kind:"bind",id:"camZoomOut",labelKey:"kb.bind.camZoomOut"},{kind:"bind",id:"drop",labelKey:"kb.bind.drop"},{kind:"bind",id:"minimapZoomIn",labelKey:"kb.bind.minimapZoomIn"},{kind:"bind",id:"minimapZoomOut",labelKey:"kb.bind.minimapZoomOut"},{kind:"bind",id:"toggleDev",labelKey:"kb.bind.toggleDev"},{kind:"bind",id:"toggleCam",labelKey:"kb.bind.toggleCam"},{kind:"bind",id:"restart",labelKey:"kb.bind.restart"}];this.list.innerHTML="";for(const n of t){if(n.kind==="spacer"){const o=document.createElement("div");o.className="kb-row kb-row--spacer",this.list.appendChild(o);continue}const s=document.createElement("div");s.className="kb-row";const r=document.createElement("div");r.className="kb-name",r.textContent=ke(n.labelKey);const a=document.createElement("button");a.className="kb-bind",a.textContent=wl(e[n.id]),a.addEventListener("click",()=>this.startRebind(n.id)),s.appendChild(r),s.appendChild(a),this.list.appendChild(s)}this.hint.textContent=ke("kb.hint_click_bind")}startRebind(e){this.stopRebind(),this.rebindId=e,this.hint.textContent=ke("kb.press_key_for",{id:e}),this.rebindHandler=t=>{if(t.preventDefault(),t.code==="Escape"){this.stopRebind(),this.hint.textContent=ke("common.canceled");return}const n=la();n[e]=t.code,Eu(n),this.stopRebind(),this.render(),this.hint.textContent=ke("kb.bound",{id:e,key:wl(t.code)})},window.addEventListener("keydown",this.rebindHandler,{capture:!0})}stopRebind(){this.rebindHandler&&window.removeEventListener("keydown",this.rebindHandler,{capture:!0}),this.rebindHandler=null,this.rebindId=null}}class PS{constructor(e){this.deps=e}btnContinue=He("#menu-continue");btnRestart=He("#menu-restart");btnKeybinds=He("#menu-keybinds");btnGamepad=He("#menu-gamepad");btnSettings=He("#menu-settings");bind(){this.btnContinue.addEventListener("click",()=>this.deps.goSim()),this.btnRestart.addEventListener("click",()=>this.deps.restart()),this.btnKeybinds.addEventListener("click",()=>this.deps.setScreen("keybindings")),this.btnGamepad.addEventListener("click",()=>this.deps.setScreen("gamepad")),this.btnSettings.addEventListener("click",()=>this.deps.setScreen("settings"))}}function Zr(i,e,t){return Math.max(e,Math.min(t,i))}function Ct(i,e){const t=Number(i);return Number.isFinite(t)?t:e}function _u(i){return i.toFixed(1)}function DS(i){return i in Dc?i:null}class IS{constructor(e){this.deps=e}back=He("#menu-back-settings");scenarioSelect=He("#scenario-select");zoneSelect=He("#zone-select");zonesLoaded=!1;windEnabled=He("#wind-enabled");windDir=He("#wind-dir");windMin=He("#wind-min");windMax=He("#wind-max");dirArrow=He("#wind-dir-arrow");windVariation=He("#wind-variation");windGustiness=He("#wind-gustiness");dirVal=He("#wind-dir-val");minVal=He("#wind-min-val");maxVal=He("#wind-max-val");variationVal=He("#wind-variation-val");gustinessVal=He("#wind-gustiness-val");apply=He("#settings-apply");localeSelect=He("#locale-select");bind(){this.back.addEventListener("click",()=>this.deps.openRoot());const e=()=>{this.normalizeWindUI(),this.updateLabels(),this.applyEnabledState()};this.windEnabled.addEventListener("change",e),this.windDir.addEventListener("input",e),this.windMin.addEventListener("input",e),this.windMax.addEventListener("input",e),this.windVariation.addEventListener("input",e),this.windGustiness.addEventListener("input",e),this.apply.addEventListener("click",()=>{this.normalizeWindUI();const t=DS(this.localeSelect.value);if(t){const n=jr();t!==n&&(Jd(t),document.documentElement.lang=jr(),Nd(document))}Pd(this.scenarioSelect.value),aS(this.zoneSelect.value),rS({enabled:this.windEnabled.checked,dirDeg:Math.floor(Ct(this.windDir.value,0))%360,speedMps:Ct(this.windMin.value,0),gustMaxMps:Ct(this.windMax.value,0),variation:Ct(this.windVariation.value,0),gustiness:Ct(this.windGustiness.value,0)}),this.deps.goSim(),window.dispatchEvent(new CustomEvent("kd:restart",{detail:{reason:"settings"}}))})}onEnter(){this.fillLocale(),this.fillScenarios(),this.fillWind(),this.fillZones(),this.normalizeWindUI(),this.updateLabels(),this.applyEnabledState()}onExit(){}fillLocale(){const e=jr();this.localeSelect.innerHTML="",Object.entries(Dc).forEach(([t,n])=>{const s=document.createElement("option");s.value=t,s.textContent=n,this.localeSelect.appendChild(s)}),this.localeSelect.value=e}fillScenarios(){this.scenarioSelect.innerHTML="";for(const e of Ca){const t=document.createElement("option");t.value=e.id,t.textContent=e.name,this.scenarioSelect.appendChild(t)}this.scenarioSelect.value=Ao().scenarioId}fillWind(){const e=Ao().windUser;this.windEnabled.checked=!!e.enabled,this.windDir.value=String(e.dirDeg??0),this.windMin.value=String(e.speedMps??0),this.windMax.value=String(e.gustMaxMps??0),this.windVariation.value=String(e.variation??0),this.windGustiness.value=String(e.gustiness??0)}async fillZones(){if(!this.zonesLoaded){this.zonesLoaded=!0,this.zoneSelect.innerHTML="";try{const e=await fetch("/maps/index.json",{cache:"no-cache"});if(!e.ok)throw new Error(`HTTP ${e.status}`);const t=await e.json();for(const[r,a]of Object.entries(t)){const o=document.createElement("option");o.value=r,o.textContent=a,this.zoneSelect.appendChild(o)}const n=Ao(),s=typeof n.zoneId=="string"?n.zoneId:"";s&&(this.zoneSelect.value=s)}catch(e){const t=document.createElement("option");t.value="",t.textContent="Failed to load maps",this.zoneSelect.appendChild(t),this.zoneSelect.disabled=!0,console.warn("Failed to load /maps/index.json",e)}}}applyEnabledState(){const e=this.windEnabled.checked;this.windDir.disabled=!e,this.windMin.disabled=!e,this.windMax.disabled=!e,this.windVariation.disabled=!e,this.windGustiness.disabled=!e;const t=e?"1":"0.5";this.dirVal.style.opacity=t,this.minVal.style.opacity=t,this.maxVal.style.opacity=t,this.variationVal.style.opacity=t,this.gustinessVal.style.opacity=t}normalizeWindUI(){let e=Math.floor(Ct(this.windDir.value,0));e=(e%360+360)%360;const t=Ct(this.windMin.min,0),n=Ct(this.windMax.max,30);let s=Ct(this.windMin.value,t),r=Ct(this.windMax.value,s);s=Zr(s,t,n),r=Zr(r,s,n);const a=Zr(Ct(this.windVariation.value,0),0,1),o=Zr(Ct(this.windGustiness.value,0),0,1);this.windDir.value=String(e),this.windMin.value=String(s),this.windMax.value=String(r),this.windVariation.value=String(a),this.windGustiness.value=String(o)}updateLabels(){const e=this.windEnabled.checked,t=Math.floor(Ct(this.windDir.value,0)),n=Ct(this.windMin.value,0),s=Ct(this.windMax.value,0),r=Ct(this.windVariation.value,0),a=Ct(this.windGustiness.value,0);this.dirVal.textContent=e?`${t}°`:"—",this.minVal.textContent=e?`${_u(n)}`:"—",this.maxVal.textContent=e?`${_u(s)}`:"—",this.variationVal.textContent=e?`${Math.round(r*100)}%`:"—",this.gustinessVal.textContent=e?`${Math.round(a*100)}%`:"—";const o=e?t:0;this.dirArrow.style.transform=`rotate(${o}deg)`,this.dirArrow.style.opacity=e?"1":"0.35"}}class LS{overlay=He("#menu-overlay");panel=He("#menu-panel");menuBtn=He("#menu-btn");fullscreenBtn=He("#fullscreen-btn");current="root";root=new PS({setScreen:e=>this.openDialog(e),openRoot:()=>this.openRoot(),goSim:()=>this.goSim(),restart:()=>this.restart()});keybinds=new CS({setScreen:e=>this.openDialog(e),openRoot:()=>this.openRoot(),goSim:()=>this.goSim(),restart:()=>this.restart()});gamepad=new RS({setScreen:e=>this.openDialog(e),openRoot:()=>this.openRoot(),goSim:()=>this.goSim(),restart:()=>this.restart()});settings=new IS({setScreen:e=>this.openDialog(e),openRoot:()=>this.openRoot(),goSim:()=>this.goSim(),restart:()=>this.restart()});constructor(){this.root.bind(),this.keybinds.bind(),this.gamepad.bind(),this.settings.bind(),this.menuBtn.addEventListener("click",()=>this.toggleRoot()),this.fullscreenBtn.addEventListener("click",()=>this.toggleFullscreen()),window.addEventListener("keydown",e=>{e.code==="Escape"&&(e.preventDefault(),this.handleEsc())}),this.syncDom()}handleEsc(){return this.current==="keybindings"&&this.keybinds.onEsc()||this.current==="gamepad"&&this.gamepad.onEsc()?void 0:Gs()==="sim"?this.openRoot():this.current!=="root"?this.openRoot():this.goSim()}toggleRoot(){Gs()==="sim"?this.openRoot():this.goSim()}toggleFullscreen(){document.fullscreenElement?document.exitFullscreen().catch(()=>{}):document.documentElement.requestFullscreen().catch(()=>{})}openRoot(){Gs()==="sim"&&Ws("menu"),this.setScreen("root"),Ws("menu"),this.syncDom()}openDialog(e){if(e==="root")return this.openRoot();Gs()==="sim"&&Ws("menu"),this.setScreen(e),Ws(e),this.syncDom()}goSim(){this.setScreen("root"),Ws("sim"),this.syncDom()}restart(){window.dispatchEvent(new CustomEvent("kd:restart",{detail:{reason:"menu"}})),this.goSim()}setScreen(e){this.current!==e&&(this.onExit(this.current),this.current=e,this.panel.dataset.screen=e,this.onEnter(e))}onEnter(e){e==="keybindings"&&this.keybinds.onEnter(),e==="gamepad"&&this.gamepad.onEnter(),e==="settings"&&this.settings.onEnter()}onExit(e){e==="keybindings"&&this.keybinds.onExit(),e==="gamepad"&&this.gamepad.onExit(),e==="settings"&&this.settings.onExit?.()}syncDom(){const e=Gs()!=="sim";this.overlay.dataset.open=e?"true":"false"}}document.documentElement.lang=jr();Nd(document);sS();let jt=Cd();const Fd=Dd(jt),Js=new bf({deadzone:.12,expo:.2}),NS=new Mf,rn=new $d(Fd,jt,[wS,fS,mS(300,.4),vy]),Pc=document.getElementById("splash"),Od=document.getElementById("view3d"),ul=document.getElementById("osd"),xu=document.getElementById("dev");if(!Od)throw new Error("#view3d canvas not found");if(!ul)throw new Error("#osd canvas not found");_f(ul);const Jn=new Ky(Od,jt);await Jn.setZone(jt.zoneId,Fd);Jn.setOnReady(()=>Pc.classList.add("splash--hide"));Jn.setCameraMode(fn.COMBAT);const cr=new tp(ul,jt);cr.setScale(1);const ms=xu?new Cf(xu,jt):null;ms&&ms.setEnabled(!1);const Ma=ms?[Jn,cr,ms]:[Jn,cr];let Bd=new vu(jt.core.fixedDt,i=>rn.step(i),Ud);new LS;function US(i){const e=NS.update(i);Js.setRaw(e.raw),Js.update();const t=Js.getFrame();t.drop=e.actions.drop,rn.world.input=t,rn.world.gamepadId=e.gamepad.id,rn.world.gamepadIndex=e.gamepad.index,rn.world.rcRaw=e.gamepad.rcRaw;const n=rn.world.input;return rn.world.rc={roll:n.roll,pitch:n.pitch,yaw:n.yaw,thr:n.throttle},Jn.setCameraAxes(e.camAxes),e.actions.toggleCam&&Jn.cycleCameraMode(),e.actions.toggleDev&&ms&&ms.toggle(),e.actions.restart&&window.dispatchEvent(new CustomEvent("kd:restart",{detail:{reason:"input"}})),e}function FS(i){for(let e=0;e<Ma.length;e++)Ma[e].render(rn.world,i)}function kd(){for(let i=0;i<Ma.length;i++)Ma[i].resize()}function zd(i){const e=US(i);cr.setControls(e),Bd.tick(i),FS(i),requestAnimationFrame(zd)}async function OS(){Pc.classList.remove("splash--hide"),jt=Cd(),rn.setConfig(jt),rn.world=Dd(jt),cr.setConfig(jt),Js.setRaw(ha()),Js.update(),Jn.resetCamera(),await Jn.setZone(jt.zoneId,rn.world),Bd=new vu(jt.core.fixedDt,i=>rn.step(i),Ud),Pc.classList.add("splash--hide")}window.addEventListener("resize",kd);window.addEventListener("kd:restart",()=>{OS()});kd();requestAnimationFrame(zd);
